...
[![Maven Central](https://img.shields.io/maven-central/v/io.stigg/stigg-java)](https://central.sonatype.com/artifact/io.stigg/stigg-java/0.1.0-alpha.15)
[![javadoc](https://javadoc.io/badge2/io.stigg/stigg-java/0.1.0-alpha.15/javadoc.svg)](https://javadoc.io/doc/io.stigg/stigg-java/0.1.0-alpha.15)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/io.stigg/stigg-java/0.1.0-alpha.15).
...
```kotlin
implementation("io.stigg:stigg-java:0.1.0-alpha.15")
```
