...
[![Maven Central](https://img.shields.io/maven-central/v/io.stigg/stigg-java)](https://central.sonatype.com/artifact/io.stigg/stigg-java/0.1.0-alpha.28)
[![javadoc](https://javadoc.io/badge2/io.stigg/stigg-java/0.1.0-alpha.28/javadoc.svg)](https://javadoc.io/doc/io.stigg/stigg-java/0.1.0-alpha.28)
...
Javadocs are available on [javadoc.io](https://javadoc.io/doc/io.stigg/stigg-java/0.1.0-alpha.28).
...
```kotlin
implementation("io.stigg:stigg-java:0.1.0-alpha.28")
```
