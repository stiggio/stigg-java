...
package com.stigg.api.client.okhttp

import com.fasterxml.jackson.databind.json.JsonMapper
import com.stigg.api.client.StiggClientAsync
import com.stigg.api.client.StiggClientAsyncImpl
...
/**
 * A class that allows building an instance of [StiggClientAsync] with [OkHttpClient] as the
 * underlying [HttpClient].
 */
class StiggOkHttpClientAsync private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [StiggClientAsync]. */
         ...
         */
        @JvmStatic fun fromEnv(): StiggClientAsync = builder().fromEnv().build()
    }

    /** A builder for [StiggOkHttpClientAsync]. */
    class Builder internal constructor() {
         ...
         *
         * Defaults to [com.stigg.api.core.jsonMapper]. The default is usually sufficient and rarely
        ...
        /**
         * Returns an immutable instance of [StiggClientAsync].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StiggClientAsync =
            StiggClientAsyncImpl(
                clientOptions
                    .httpClient(
