...
import io.stigg.client.StiggClientImpl
...
/**
 * A class that allows building an instance of [StiggClient] with [OkHttpClient] as the underlying
 * [HttpClient].
 */
class StiggOkHttpClient private constructor() {

    companion object {

        /** Returns a mutable builder for constructing an instance of [StiggClient]. */
         ...
         */
        @JvmStatic fun fromEnv(): StiggClient = builder().fromEnv().build()
    }

    /** A builder for [StiggOkHttpClient]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [StiggClient].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): StiggClient =
            StiggClientImpl(
                clientOptions
                    .httpClient(
