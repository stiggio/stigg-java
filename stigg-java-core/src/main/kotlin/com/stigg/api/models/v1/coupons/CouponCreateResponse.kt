...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CouponCreateResponse].
         *
    ...
    /** A builder for [CouponCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(couponCreateResponse: CouponCreateResponse) = apply {
        ...
        /**
         * Returns an immutable instance of [CouponCreateResponse].
         *
         ...
         */
        fun build(): CouponCreateResponse =
            CouponCreateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CouponCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CouponCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CouponCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
