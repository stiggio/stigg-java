...
private constructor(
     ...
     *
     * Unlike [billingLinkUrl], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("billingLinkUrl")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(couponListResponse: CouponListResponse) = apply {
            id = couponListResponse.id
            amountsOff = couponListResponse.amountsOff.map { it.toMutableList() }
            billingId = couponListResponse.billingId
            billingLinkUrl = couponListResponse.billingLinkUrl
            ...
            status = couponListResponse.status
            type = couponListResponse.type
            updatedAt = couponListResponse.updatedAt
        ...
        /** Fixed amount discounts in different currencies */
        fun amountsOff(amountsOff: List<AmountsOff>?) = amountsOff(JsonField.ofNullable(amountsOff))
