...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CouponRetrieveResponse].
         *
    ...
    /** A builder for [CouponRetrieveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(couponRetrieveResponse: CouponRetrieveResponse) = apply {
            data = couponRetrieveResponse.data
            additionalProperties = couponRetrieveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CouponRetrieveResponse].
         *
         ...
         */
        fun build(): CouponRetrieveResponse =
            CouponRetrieveResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): CouponRetrieveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, amountsOff=$amountsOff, billingId=$billingId, billingLinkUrl=$billingLinkUrl, createdAt=$createdAt, description=$description, durationInMonths=$durationInMonths, name=$name, percentOff=$percentOff, source=$source, status=$status, type=$type, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CouponRetrieveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CouponRetrieveResponse{data=$data, additionalProperties=$additionalProperties}"
}
