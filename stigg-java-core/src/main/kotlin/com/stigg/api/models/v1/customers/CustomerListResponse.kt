...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("cursor_id") @ExcludeMissing cursorId: JsonField<String> = JsonMissing.of(),
     ...
     *   missing or null (e.g. if the server responded with an unexpected value).
     */
    fun cursorId(): String = cursorId.getRequired("cursor_id")
     ...
     */
    @JsonProperty("cursor_id") @ExcludeMissing fun _cursorId(): JsonField<String> = cursorId
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerListResponse: CustomerListResponse) = apply {
            ...
            cursorId = customerListResponse.cursorId
            email = customerListResponse.email
            externalId = customerListResponse.externalId
            name = customerListResponse.name
            updatedAt = customerListResponse.updatedAt
            defaultPaymentMethod = customerListResponse.defaultPaymentMethod
            integrations = customerListResponse.integrations.map { it.toMutableList() }
            metadata = customerListResponse.metadata
         ...
         *
         * You should usually call [Builder.cursorId] with a well-typed [String] value instead. This
    ...
    override fun toString() =
        "CustomerListResponse{archivedAt=$archivedAt, createdAt=$createdAt, cursorId=$cursorId, email=$email, externalId=$externalId, name=$name, updatedAt=$updatedAt, defaultPaymentMethod=$defaultPaymentMethod, integrations=$integrations, metadata=$metadata, additionalProperties=$additionalProperties}"
}
