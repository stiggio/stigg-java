...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PromotionalCreateParams].
         *
    ...
    /** A builder for [PromotionalCreateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promotionalCreateParams: PromotionalCreateParams) = apply {
            customerId = promotionalCreateParams.customerId
            body = promotionalCreateParams.body.toBuilder()
            additionalHeaders = promotionalCreateParams.additionalHeaders.toBuilder()
            additionalQueryParams = promotionalCreateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [PromotionalCreateParams].
         *
         ...
         */
        fun build(): PromotionalCreateParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalCreateParams &&
    ...
    override fun toString() =
        "PromotionalCreateParams{customerId=$customerId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
