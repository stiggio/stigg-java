...
import com.stigg.api.core.BaseDeserializer
import com.stigg.api.core.BaseSerializer
...
class PromotionalCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PromotionalCreateResponse].
         *
    ...
    /** A builder for [PromotionalCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promotionalCreateResponse: PromotionalCreateResponse) = apply {
            data = promotionalCreateResponse.data.map { it.toMutableList() }
            additionalProperties = promotionalCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PromotionalCreateResponse].
         *
         ...
         */
        fun build(): PromotionalCreateResponse =
    ...
    fun validate(): PromotionalCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * `ResetPeriodConfiguration.ofAccordingTo(accordingTo)`.
             */
            fun resetPeriodConfiguration(accordingTo: ResetPeriodConfiguration.AccordingTo) =
                resetPeriodConfiguration(ResetPeriodConfiguration.ofAccordingTo(accordingTo))
        ...
        private constructor(
            private val accordingTo: AccordingTo? = null,
            private val accordingTo: AccordingTo? = null,
            private val accordingTo: AccordingTo? = null,
            private val _json: JsonValue? = null,
        ) {

            fun accordingTo(): Optional<AccordingTo> = Optional.ofNullable(accordingTo)

            fun accordingTo(): Optional<AccordingTo> = Optional.ofNullable(accordingTo)

            fun accordingTo(): Optional<AccordingTo> = Optional.ofNullable(accordingTo)

            fun isAccordingTo(): Boolean = accordingTo != null

            fun isAccordingTo(): Boolean = accordingTo != null

            fun isAccordingTo(): Boolean = accordingTo != null

            fun asAccordingTo(): AccordingTo = accordingTo.getOrThrow("accordingTo")
            ...
            fun <T> accept(visitor: Visitor<T>): T =
                when {
                    accordingTo != null -> visitor.visitAccordingTo(accordingTo)
                    accordingTo != null -> visitor.visitAccordingTo(accordingTo)
                    accordingTo != null -> visitor.visitAccordingTo(accordingTo)
            ...
            fun validate(): ResetPeriodConfiguration = apply {
                ...
                accept(
                    object : Visitor<Unit> {
                        override fun visitAccordingTo(accordingTo: AccordingTo) {
            ...
            override fun hashCode(): Int = Objects.hash(accordingTo, accordingTo, accordingTo)

            override fun toString(): String =
                when {
                    accordingTo != null -> "ResetPeriodConfiguration{accordingTo=$accordingTo}"
                    accordingTo != null -> "ResetPeriodConfiguration{accordingTo=$accordingTo}"
                    accordingTo != null -> "ResetPeriodConfiguration{accordingTo=$accordingTo}"
            ...
            companion object {
                ...
                @JvmStatic
                fun ofAccordingTo(accordingTo: AccordingTo) =
                    ResetPeriodConfiguration(accordingTo = accordingTo)
            ...
            interface Visitor<out T> {
                ...
                fun visitAccordingTo(accordingTo: AccordingTo): T
            ...
            internal class Deserializer :
                ...
                override fun ObjectCodec.deserialize(node: JsonNode): ResetPeriodConfiguration {
                    ...
                    val bestMatches =
                        sequenceOf(
                                tryDeserialize(node, jacksonTypeRef<AccordingTo>())?.let {
                                    ResetPeriodConfiguration(accordingTo = it, _json = json)
                                },
                                tryDeserialize(node, jacksonTypeRef<AccordingTo>())?.let {
                                    ResetPeriodConfiguration(accordingTo = it, _json = json)
                                },
            ...
            internal class Serializer :
                ...
                override fun serialize(
                    ...
                    when {
                        value.accordingTo != null -> generator.writeObject(value.accordingTo)
                        value.accordingTo != null -> generator.writeObject(value.accordingTo)
                        value.accordingTo != null -> generator.writeObject(value.accordingTo)
            ...
            @JsonCreator(mode = JsonCreator.Mode.DISABLED)
            private constructor(
                private val accordingTo: JsonField<InnerAccordingTo>,
                private val additionalProperties: MutableMap<String, JsonValue>,
            ) {
                ...
                private constructor(
                    ...
                    @ExcludeMissing
                    accordingTo: JsonField<InnerAccordingTo> = JsonMissing.of()
                 ...
                 *   value).
                 */
                fun accordingTo(): InnerAccordingTo = accordingTo.getRequired("accordingTo")
                ...
                @JsonProperty("accordingTo")
                @ExcludeMissing
                fun _accordingTo(): JsonField<InnerAccordingTo> = accordingTo
                ...
                companion object {
                    ...
                    /**
                     * Returns a mutable builder for constructing an instance of [AccordingTo].
                     *
                     * The following fields are required:
                     * ```java
                     * .accordingTo()
                ...
                /** A builder for [AccordingTo]. */
                class Builder internal constructor() {

                    private var accordingTo: JsonField<InnerAccordingTo>? = null
                    private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

                    @JvmSynthetic
                    internal fun from(accordingTo: AccordingTo) = apply {
                        this.accordingTo = accordingTo.accordingTo
                        additionalProperties = accordingTo.additionalProperties.toMutableMap()
                    }

                    /** Yearly reset period according to */
                    fun accordingTo(accordingTo: InnerAccordingTo) =
                     ...
                     * [InnerAccordingTo] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                    fun accordingTo(accordingTo: JsonField<InnerAccordingTo>) = apply {
                    ...
                    /**
                     * Returns an immutable instance of [AccordingTo].
                     *
                     * Further updates to this [Builder] will not mutate the returned instance.
                     *
                     * The following fields are required:
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    companion object {
                        ...
                        @JvmStatic fun of(value: String) = InnerAccordingTo(JsonField.of(value))
                    }

                    /** An enum containing [InnerAccordingTo]'s known values. */
                    enum class Known {
                        SUBSCRIPTION_START
                    }

                    /**
                     * An enum containing [InnerAccordingTo]'s known values, as well as an
                     * [_UNKNOWN] member.
                     *
                     * An instance of [InnerAccordingTo] can contain an unknown value in a couple of
                     * cases:
                    ...
                    enum class Value {
                        SUBSCRIPTION_START,
                        /**
                         * An enum member indicating that [InnerAccordingTo] was instantiated with
                         * an unknown value.
                         */
                        _UNKNOWN,
                    }
                    ...
                    fun known(): Known =
                        when (this) {
                            SUBSCRIPTION_START -> Known.SUBSCRIPTION_START
                                ...
                                throw StiggInvalidDataException("Unknown InnerAccordingTo: $value")
                        }
                    ...
                    fun validate(): InnerAccordingTo = apply {
                        if (validated) {
                            return@apply
                        }
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return other is InnerAccordingTo && value == other.value
                    }
                ...
                override fun toString() =
                    "AccordingTo{accordingTo=$accordingTo, additionalProperties=$additionalProperties}"
            }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PromotionalCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
