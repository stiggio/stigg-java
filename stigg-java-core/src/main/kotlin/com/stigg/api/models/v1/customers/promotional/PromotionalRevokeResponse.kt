...
class PromotionalRevokeResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PromotionalRevokeResponse].
         *
    ...
    /** A builder for [PromotionalRevokeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promotionalRevokeResponse: PromotionalRevokeResponse) = apply {
            data = promotionalRevokeResponse.data
            additionalProperties = promotionalRevokeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PromotionalRevokeResponse].
         *
         ...
         */
        fun build(): PromotionalRevokeResponse =
    ...
    fun validate(): PromotionalRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalRevokeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PromotionalRevokeResponse{data=$data, additionalProperties=$additionalProperties}"
}
