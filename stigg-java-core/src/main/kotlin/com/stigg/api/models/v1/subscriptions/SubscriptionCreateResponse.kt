...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, status=$status, checkoutBillingId=$checkoutBillingId, checkoutUrl=$checkoutUrl, isScheduled=$isScheduled, subscription=$subscription, additionalProperties=$additionalProperties}"
    }
