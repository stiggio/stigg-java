...
class SubscriptionDelegateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionDelegateResponse].
         *
    ...
    /** A builder for [SubscriptionDelegateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionDelegateResponse: SubscriptionDelegateResponse) = apply {
            data = subscriptionDelegateResponse.data
            additionalProperties = subscriptionDelegateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionDelegateResponse].
         *
         ...
         */
        fun build(): SubscriptionDelegateResponse =
    ...
    fun validate(): SubscriptionDelegateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionDelegateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SubscriptionDelegateResponse{data=$data, additionalProperties=$additionalProperties}"
}
