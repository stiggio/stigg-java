...
private constructor(
    ...
    /** A builder for [FutureUpdateCancelScheduleResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(futureUpdateCancelScheduleResponse: FutureUpdateCancelScheduleResponse) =
            apply {
                data = futureUpdateCancelScheduleResponse.data
                additionalProperties =
                    futureUpdateCancelScheduleResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FutureUpdateCancelScheduleResponse].
         *
         ...
         */
        fun build(): FutureUpdateCancelScheduleResponse =
            FutureUpdateCancelScheduleResponse(
    ...
    fun validate(): FutureUpdateCancelScheduleResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FutureUpdateCancelScheduleResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FutureUpdateCancelScheduleResponse{data=$data, additionalProperties=$additionalProperties}"
}
