...
package io.stigg.core

import com.fasterxml.jackson.databind.json.JsonMapper
import io.stigg.core.http.AsyncStreamResponse
import io.stigg.core.http.Headers
import io.stigg.core.http.HttpClient
import io.stigg.core.http.LoggingHttpClient
import io.stigg.core.http.PhantomReachableClosingHttpClient
import io.stigg.core.http.QueryParams
import io.stigg.core.http.RetryingHttpClient
...
private constructor(
     ...
     *
     * Use the one published in `stigg-java-client-okhttp` or implement your own.
     *
     ...
     *
     * Defaults to [io.stigg.core.jsonMapper]. The default is usually sufficient and rarely needs to
     * be overridden.
     */
    ...
    class Builder internal constructor() {
        ...
        fun fromEnv() = apply {
            ...
            System.getenv("STIGG_CUSTOM_HEADERS")?.let { customHeadersEnv ->
