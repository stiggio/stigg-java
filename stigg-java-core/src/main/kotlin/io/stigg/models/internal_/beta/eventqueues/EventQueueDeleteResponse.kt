...
/** Response object */
class EventQueueDeleteResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventQueueDeleteResponse].
         *
    ...
    /** A builder for [EventQueueDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventQueueDeleteResponse: EventQueueDeleteResponse) = apply {
            data = eventQueueDeleteResponse.data
            additionalProperties = eventQueueDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventQueueDeleteResponse].
         *
         ...
         */
        fun build(): EventQueueDeleteResponse =
    ...
    fun validate(): EventQueueDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventQueueDeleteResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EventQueueDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
