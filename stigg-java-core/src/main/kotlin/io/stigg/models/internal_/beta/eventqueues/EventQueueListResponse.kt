...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventQueueListResponse].
         *
    ...
    /** A builder for [EventQueueListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventQueueListResponse: EventQueueListResponse) = apply {
            data = eventQueueListResponse.data.map { it.toMutableList() }
            pagination = eventQueueListResponse.pagination
            additionalProperties = eventQueueListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventQueueListResponse].
         *
         ...
         */
        fun build(): EventQueueListResponse =
    ...
    fun validate(): EventQueueListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventQueueListResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "EventQueueListResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
