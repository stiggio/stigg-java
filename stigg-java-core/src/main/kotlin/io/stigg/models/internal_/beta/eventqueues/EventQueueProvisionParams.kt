...
class EventQueueProvisionParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventQueueProvisionParams].
         *
    ...
    /** A builder for [EventQueueProvisionParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventQueueProvisionParams: EventQueueProvisionParams) = apply {
            body = eventQueueProvisionParams.body.toBuilder()
            additionalHeaders = eventQueueProvisionParams.additionalHeaders.toBuilder()
            additionalQueryParams = eventQueueProvisionParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventQueueProvisionParams].
         *
         ...
         */
        fun build(): EventQueueProvisionParams =
    ...
    /** Request to provision an event queue for the current environment */
    class Body
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{region=$region, allowedAssumeRoleArns=$allowedAssumeRoleArns, createLowPriorityQueues=$createLowPriorityQueues, eventTypes=$eventTypes, suffix=$suffix, additionalProperties=$additionalProperties}"
    }
    ...
    class EventType @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
        ...
        companion object {
            ...
            @JvmField val INCOMING_AIRBYTE_WEBHOOK = of("INCOMING_AIRBYTE_WEBHOOK")
            ...
            @JvmField val DATA_EXPORT_SYNC_FAILED = of("DATA_EXPORT_SYNC_FAILED")
            ...
            @JvmField val CUSTOM_CURRENCY_CREATED = of("CUSTOM_CURRENCY_CREATED")

            @JvmField val CUSTOM_CURRENCY_UPDATED = of("CUSTOM_CURRENCY_UPDATED")

            @JvmField val CUSTOM_CURRENCY_ARCHIVED = of("CUSTOM_CURRENCY_ARCHIVED")

            @JvmField val CUSTOM_CURRENCY_UNARCHIVED = of("CUSTOM_CURRENCY_UNARCHIVED")
        ...
        fun value(): Value =
            when (this) {
                ...
                INCOMING_AIRBYTE_WEBHOOK -> Value.INCOMING_AIRBYTE_WEBHOOK
                ...
                DATA_EXPORT_SYNC_FAILED -> Value.DATA_EXPORT_SYNC_FAILED
                ...
                CUSTOM_CURRENCY_CREATED -> Value.CUSTOM_CURRENCY_CREATED
                CUSTOM_CURRENCY_UPDATED -> Value.CUSTOM_CURRENCY_UPDATED
                CUSTOM_CURRENCY_ARCHIVED -> Value.CUSTOM_CURRENCY_ARCHIVED
                CUSTOM_CURRENCY_UNARCHIVED -> Value.CUSTOM_CURRENCY_UNARCHIVED
        ...
        fun known(): Known =
            when (this) {
                ...
                INCOMING_AIRBYTE_WEBHOOK -> Known.INCOMING_AIRBYTE_WEBHOOK
                ...
                DATA_EXPORT_SYNC_FAILED -> Known.DATA_EXPORT_SYNC_FAILED
                ...
                CUSTOM_CURRENCY_CREATED -> Known.CUSTOM_CURRENCY_CREATED
                CUSTOM_CURRENCY_UPDATED -> Known.CUSTOM_CURRENCY_UPDATED
                CUSTOM_CURRENCY_ARCHIVED -> Known.CUSTOM_CURRENCY_ARCHIVED
                CUSTOM_CURRENCY_UNARCHIVED -> Known.CUSTOM_CURRENCY_UNARCHIVED
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventQueueProvisionParams &&
            body == other.body &&
    ...
    override fun toString() =
        "EventQueueProvisionParams{body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
