...
/** Response object */
class EventQueueUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventQueueUpdateResponse].
         *
    ...
    /** A builder for [EventQueueUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventQueueUpdateResponse: EventQueueUpdateResponse) = apply {
            data = eventQueueUpdateResponse.data
            additionalProperties = eventQueueUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EventQueueUpdateResponse].
         *
         ...
         */
        fun build(): EventQueueUpdateResponse =
    ...
    fun validate(): EventQueueUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventQueueUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EventQueueUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
