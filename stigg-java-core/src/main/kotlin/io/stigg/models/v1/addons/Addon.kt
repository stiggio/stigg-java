...
private constructor(
    ...
    class Builder internal constructor() {
         ...
         */
        fun build(): Addon = Addon(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    override fun toString() = "Addon{data=$data, additionalProperties=$additionalProperties}"
}
