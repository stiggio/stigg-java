...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AddonArchiveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AddonArchiveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AddonArchiveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [AddonArchiveParams].
         *
