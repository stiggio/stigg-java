...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AddonCreateDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AddonCreateDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AddonCreateDraftParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(addonCreateDraftParams: AddonCreateDraftParams) = apply {
            ...
            additionalBodyProperties =
                addonCreateDraftParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonCreateDraftParams].
         *
