...
class AddonListChargesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AddonListChargesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AddonListChargesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AddonListChargesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AddonListChargesResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonListChargesPageResponse].
         *
    ...
    /** A builder for [AddonListChargesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AddonListChargesResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(addonListChargesPageResponse: AddonListChargesPageResponse) = apply {
            data = addonListChargesPageResponse.data.map { it.toMutableList() }
            pagination = addonListChargesPageResponse.pagination
            additionalProperties = addonListChargesPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AddonListChargesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AddonListChargesResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<AddonListChargesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AddonListChargesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AddonListChargesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AddonListChargesPageResponse].
         *
         ...
         */
        fun build(): AddonListChargesPageResponse =
            AddonListChargesPageResponse(
     ...
     *   type.
     */
    fun validate(): AddonListChargesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListChargesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AddonListChargesPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
