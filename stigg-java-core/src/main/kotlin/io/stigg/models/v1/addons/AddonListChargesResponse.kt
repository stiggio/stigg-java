 ...
 */
class AddonListChargesResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonListChargesResponse].
         *
    ...
    /** A builder for [AddonListChargesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonListChargesResponse: AddonListChargesResponse) = apply {
            id = addonListChargesResponse.id
            billingCadence = addonListChargesResponse.billingCadence
            billingModel = addonListChargesResponse.billingModel
            billingPeriod = addonListChargesResponse.billingPeriod
            createdAt = addonListChargesResponse.createdAt
            billingCountryCode = addonListChargesResponse.billingCountryCode
            billingId = addonListChargesResponse.billingId
            blockSize = addonListChargesResponse.blockSize
            creditGrantCadence = addonListChargesResponse.creditGrantCadence
            creditRate = addonListChargesResponse.creditRate
            crmId = addonListChargesResponse.crmId
            crmLinkUrl = addonListChargesResponse.crmLinkUrl
            featureId = addonListChargesResponse.featureId
            maxUnitQuantity = addonListChargesResponse.maxUnitQuantity
            minUnitQuantity = addonListChargesResponse.minUnitQuantity
            price = addonListChargesResponse.price
            tiers = addonListChargesResponse.tiers.map { it.toMutableList() }
            tiersMode = addonListChargesResponse.tiersMode
            topUpCustomCurrencyId = addonListChargesResponse.topUpCustomCurrencyId
            usedInSubscriptions = addonListChargesResponse.usedInSubscriptions
            additionalProperties = addonListChargesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonListChargesResponse].
         *
         ...
         */
        fun build(): AddonListChargesResponse =
     ...
     *   type.
     */
    fun validate(): AddonListChargesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListChargesResponse &&
            id == other.id &&
