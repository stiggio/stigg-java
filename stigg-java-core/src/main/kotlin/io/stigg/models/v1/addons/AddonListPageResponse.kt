...
private constructor(
    private val data: JsonField<List<AddonListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AddonListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AddonListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<AddonListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<AddonListResponse>>? = null
        ...
        internal fun from(addonListPageResponse: AddonListPageResponse) = apply {
            data = addonListPageResponse.data.map { it.toMutableList() }
            pagination = addonListPageResponse.pagination
            additionalProperties = addonListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AddonListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AddonListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<AddonListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AddonListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AddonListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "AddonListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
