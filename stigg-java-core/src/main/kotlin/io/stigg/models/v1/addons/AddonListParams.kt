...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(addonListParams: AddonListParams) = apply {
            ...
            xAccountId = addonListParams.xAccountId
            xEnvironmentId = addonListParams.xEnvironmentId
    ...
    override fun toString() =
        "AddonListParams{after=$after, before=$before, createdAt=$createdAt, limit=$limit, productId=$productId, status=$status, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
