...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonListResponse].
         *
    ...
    /** A builder for [AddonListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonListResponse: AddonListResponse) = apply {
            id = addonListResponse.id
            billingId = addonListResponse.billingId
            createdAt = addonListResponse.createdAt
            dependencies = addonListResponse.dependencies.map { it.toMutableList() }
            description = addonListResponse.description
            displayName = addonListResponse.displayName
            entitlements = addonListResponse.entitlements.map { it.toMutableList() }
            isLatest = addonListResponse.isLatest
            maxQuantity = addonListResponse.maxQuantity
            metadata = addonListResponse.metadata
            pricingType = addonListResponse.pricingType
            productId = addonListResponse.productId
            status = addonListResponse.status
            updatedAt = addonListResponse.updatedAt
            versionNumber = addonListResponse.versionNumber
            additionalProperties = addonListResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonListResponse].
         *
     ...
     *   type.
     */
    fun validate(): AddonListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListResponse &&
            id == other.id &&
