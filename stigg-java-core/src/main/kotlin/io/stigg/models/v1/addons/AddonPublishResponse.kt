...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonPublishResponse].
         *
    ...
    /** A builder for [AddonPublishResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonPublishResponse: AddonPublishResponse) = apply {
            data = addonPublishResponse.data
            additionalProperties = addonPublishResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonPublishResponse].
         *
         ...
         */
        fun build(): AddonPublishResponse =
            AddonPublishResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): AddonPublishResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** Task ID for tracking the async publish operation */
            fun taskId(taskId: String?) = taskId(JsonField.ofNullable(taskId))
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonPublishResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonPublishResponse{data=$data, additionalProperties=$additionalProperties}"
}
