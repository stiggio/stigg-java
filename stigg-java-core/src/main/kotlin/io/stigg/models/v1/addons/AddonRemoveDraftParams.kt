...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AddonRemoveDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AddonRemoveDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AddonRemoveDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonRemoveDraftParams: AddonRemoveDraftParams) = apply {
            id = addonRemoveDraftParams.id
            xAccountId = addonRemoveDraftParams.xAccountId
            xEnvironmentId = addonRemoveDraftParams.xEnvironmentId
            additionalHeaders = addonRemoveDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = addonRemoveDraftParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                addonRemoveDraftParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonRemoveDraftParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AddonRemoveDraftParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonRemoveDraftParams &&
            id == other.id &&
    ...
    override fun toString() =
        "AddonRemoveDraftParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
