...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ChargeList].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(chargeList: ChargeList) = apply {
            data = chargeList.data.map { it.toMutableList() }
            pagination = chargeList.pagination
            additionalProperties = chargeList.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ChargeList].
         *
     ...
     * billingModel, billingCadence, billingCountryCode) combination. Plans and addons own many of
     * these — one per currency / billing period / feature.
     */
    class Data
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        @JsonProperty("crmLinkUrl")
        @ExcludeMissing
        fun _crmLinkUrl(): JsonField<String> = crmLinkUrl
         ...
         *
         * Unlike [usedInSubscriptions], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("usedInSubscriptions")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                creditGrantCadence = data.creditGrantCadence
                creditRate = data.creditRate
                crmId = data.crmId
                crmLinkUrl = data.crmLinkUrl
                featureId = data.featureId
                maxUnitQuantity = data.maxUnitQuantity
                minUnitQuantity = data.minUnitQuantity
                price = data.price
                tiers = data.tiers.map { it.toMutableList() }
                tiersMode = data.tiersMode
                topUpCustomCurrencyId = data.topUpCustomCurrencyId
                usedInSubscriptions = data.usedInSubscriptions
            ...
            /**
             * Alias for calling [Builder.creditGrantCadence] with
             * `creditGrantCadence.orElse(null)`.
             */
             ...
             *
             * You should usually call [Builder.crmId] with a well-typed [String] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.crmLinkUrl] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             */
            fun maxUnitQuantity(maxUnitQuantity: Double) =
                maxUnitQuantity(maxUnitQuantity as Double?)
             ...
             */
            fun minUnitQuantity(minUnitQuantity: Double) =
                minUnitQuantity(minUnitQuantity as Double?)
            ...
            /**
             * Alias for calling [Builder.usedInSubscriptions] with
             * `usedInSubscriptions.orElse(null)`.
             */
             ...
             *
             * You should usually call [Builder.usedInSubscriptions] with a well-typed [Boolean]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
    ...
    override fun toString() =
        "ChargeList{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
