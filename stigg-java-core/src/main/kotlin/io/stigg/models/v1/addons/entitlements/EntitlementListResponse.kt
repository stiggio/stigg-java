...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entitlementListResponse: EntitlementListResponse) = apply {
            data = entitlementListResponse.data.map { it.toMutableList() }
    ...
    override fun toString() =
        "EntitlementListResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
