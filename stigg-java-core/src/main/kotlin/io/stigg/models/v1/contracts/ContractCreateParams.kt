 ...
 * atomic operation. Every new subscription is created inside one transaction — any validation or
 * creation failure rolls the whole contract back. Each subscription entry is either a new
...
private constructor(
    ...
    /**
     * Whether to set up billing for the contract by creating a billing contract in the connected
     * billing provider. When false, the contract only provisions access (grants entitlements) and
     * no billing contract is created. Defaults to true.
     *
     * @throws StiggInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractCreateParams: ContractCreateParams) = apply {
            xAccountId = contractCreateParams.xAccountId
            xEnvironmentId = contractCreateParams.xEnvironmentId
         ...
         * connected billing provider. When false, the contract only provisions access (grants
         * entitlements) and no billing contract is created. Defaults to true.
         */
    ...
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        private val existingSubscriptionId: JsonField<String>,
        private val newSubscription: JsonField<NewSubscription>,
        private val additionalProperties: MutableMap<String, JsonValue>,
    ) {

        @JsonCreator
        private constructor(
            @JsonProperty("existingSubscriptionId")
            @ExcludeMissing
            existingSubscriptionId: JsonField<String> = JsonMissing.of(),
            @JsonProperty("newSubscription")
            @ExcludeMissing
            newSubscription: JsonField<NewSubscription> = JsonMissing.of(),
        ) : this(existingSubscriptionId, newSubscription, mutableMapOf())
         ...
         *   server responded with an unexpected value).
         */
        fun existingSubscriptionId(): Optional<String> =
            existingSubscriptionId.getOptional("existingSubscriptionId")

        /**
         * A new subscription to create, using the same body the provision-subscription endpoint
         * accepts
         *
         * @throws StiggInvalidDataException if the JSON field has an unexpected type (e.g. if the
         *   server responded with an unexpected value).
         */
        fun newSubscription(): Optional<NewSubscription> =
            newSubscription.getOptional("newSubscription")

        /**
         * Returns the raw JSON value of [existingSubscriptionId].
         *
         * Unlike [existingSubscriptionId], this method doesn't throw if the JSON field has an
         * unexpected type.
         */
        @JsonProperty("existingSubscriptionId")
        @ExcludeMissing
        fun _existingSubscriptionId(): JsonField<String> = existingSubscriptionId

        /**
         * Returns the raw JSON value of [newSubscription].
         *
         * Unlike [newSubscription], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("newSubscription")
        @ExcludeMissing
        fun _newSubscription(): JsonField<NewSubscription> = newSubscription
        ...
        class Builder internal constructor() {
            ...
            private var existingSubscriptionId: JsonField<String> = JsonMissing.of()
            private var newSubscription: JsonField<NewSubscription> = JsonMissing.of()
            private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

            @JvmSynthetic
            internal fun from(subscription: Subscription) = apply {
                existingSubscriptionId = subscription.existingSubscriptionId
                newSubscription = subscription.newSubscription
                additionalProperties = subscription.additionalProperties.toMutableMap()
            }

            /** The subscription ref ID of an already-created custom subscription to link */
            fun existingSubscriptionId(existingSubscriptionId: String) =
                existingSubscriptionId(JsonField.of(existingSubscriptionId))

            /**
             * Sets [Builder.existingSubscriptionId] to an arbitrary JSON value.
             *
             * You should usually call [Builder.existingSubscriptionId] with a well-typed [String]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun existingSubscriptionId(existingSubscriptionId: JsonField<String>) = apply {
             ...
             * accepts
             */
            fun newSubscription(newSubscription: NewSubscription) =
                newSubscription(JsonField.of(newSubscription))

            /**
             * Sets [Builder.newSubscription] to an arbitrary JSON value.
             *
             * You should usually call [Builder.newSubscription] with a well-typed [NewSubscription]
             * value instead. This method is primarily for setting the field to an undocumented or
             * not yet supported value.
             */
            fun newSubscription(newSubscription: JsonField<NewSubscription>) = apply {
        ...
        fun validate(): Subscription = apply {
            ...
            existingSubscriptionId()
            newSubscription().ifPresent { it.validate() }
            validated = true
        }
        ...
        @JvmSynthetic
        internal fun validity(): Int =
            (if (existingSubscriptionId.asKnown().isPresent) 1 else 0) +
                (newSubscription.asKnown().getOrNull()?.validity() ?: 0)
        ...
        private constructor(
             ...
             *   the server responded with an unexpected value).
             */
            fun appliedCoupon(): Optional<AppliedCoupon> =
                appliedCoupon.getOptional("appliedCoupon")
             ...
             *   the server responded with an unexpected value).
             */
            fun billingPeriod(): Optional<BillingPeriod> =
                billingPeriod.getOptional("billingPeriod")
             ...
             *   the server responded with an unexpected value).
             */
            fun entitlements(): Optional<List<Entitlement>> =
            ...
            @JsonProperty("charges")
            @ExcludeMissing
            fun _charges(): JsonField<List<Charge>> = charges

            /**
             * Returns the raw JSON value of [checkoutOptions].
             *
             * Unlike [checkoutOptions], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("checkoutOptions")
            @ExcludeMissing
             ...
             *
             * Unlike [priceOverrides], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("priceOverrides")
            @ExcludeMissing
             ...
             *
             * Unlike [scheduleStrategy], this method doesn't throw if the JSON field has an
             * unexpected type.
             */
            @JsonProperty("scheduleStrategy")
            @ExcludeMissing
             ...
             *
             * Unlike [trialOverrideConfiguration], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("trialOverrideConfiguration")
            @ExcludeMissing
            ...
            companion object {
                ...
                /**
                 * Returns a mutable builder for constructing an instance of [NewSubscription].
                 *
                 * The following fields are required:
                 * ```java
                 * .customerId()
            ...
            class Builder internal constructor() {
                ...
                @JvmSynthetic
                internal fun from(newSubscription: NewSubscription) = apply {
                    customerId = newSubscription.customerId
                    planId = newSubscription.planId
                    id = newSubscription.id
                    addons = newSubscription.addons.map { it.toMutableList() }
                    appliedCoupon = newSubscription.appliedCoupon
                    awaitPaymentConfirmation = newSubscription.awaitPaymentConfirmation
                    billingCountryCode = newSubscription.billingCountryCode
                    billingCycleAnchor = newSubscription.billingCycleAnchor
                    billingId = newSubscription.billingId
                    billingInformation = newSubscription.billingInformation
                    billingPeriod = newSubscription.billingPeriod
                    budget = newSubscription.budget
                    cancellationDate = newSubscription.cancellationDate
                    charges = newSubscription.charges.map { it.toMutableList() }
                    checkoutOptions = newSubscription.checkoutOptions
                    entitlements = newSubscription.entitlements.map { it.toMutableList() }
                    metadata = newSubscription.metadata
                    minimumSpend = newSubscription.minimumSpend
                    payingCustomerId = newSubscription.payingCustomerId
                    paymentCollectionMethod = newSubscription.paymentCollectionMethod
                    priceOverrides = newSubscription.priceOverrides.map { it.toMutableList() }
                    resourceId = newSubscription.resourceId
                    salesforceId = newSubscription.salesforceId
                    scheduleStrategy = newSubscription.scheduleStrategy
                    startDate = newSubscription.startDate
                    trialOverrideConfiguration = newSubscription.trialOverrideConfiguration
                    unitQuantity = newSubscription.unitQuantity
                    additionalProperties = newSubscription.additionalProperties.toMutableMap()
                }
                 ...
                 * [BillingCycleAnchor] value instead. This method is primarily for setting the
                 ...
                 * [BillingInformation] value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 *
                 * You should usually call [Builder.checkoutOptions] with a well-typed
                 * [CheckoutOptions] value instead. This method is primarily for setting the field
                 ...
                 * `List<Entitlement>` value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                 ...
                 * `List<PriceOverride>` value instead. This method is primarily for setting the
                 * field to an undocumented or not yet supported value.
                 */
                 ...
                 * [ScheduleStrategy] value instead. This method is primarily for setting the field
                 * to an undocumented or not yet supported value.
                 */
                ...
                fun trialOverrideConfiguration(
                    trialOverrideConfiguration: TrialOverrideConfiguration
                 ...
                 * [TrialOverrideConfiguration] value instead. This method is primarily for setting
                ...
                /**
                 * Returns an immutable instance of [NewSubscription].
                 *
                 * Further updates to this [Builder] will not mutate the returned instance.
                 *
                 * The following fields are required:
             ...
             *   expected type.
             */
            fun validate(): NewSubscription = apply {
                if (validated) {
                    return@apply
                }
            ...
            private constructor(
                 ...
                 */
                fun billingCouponId(): Optional<String> =
                    billingCouponId.getOptional("billingCouponId")
                 ...
                 *
                 * Unlike [billingCouponId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("billingCouponId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [promotionCode], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("promotionCode")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.billingCouponId] with a well-typed [String]
                    ...
                    fun promotionCode(promotionCode: String) =
                        promotionCode(JsonField.of(promotionCode))

                    /**
                     * Sets [Builder.promotionCode] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.promotionCode] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                ...
                private constructor(
                    ...
                    class Builder internal constructor() {
                        ...
                        fun startDate(startDate: OffsetDateTime) =
                            startDate(JsonField.of(startDate))
                    ...
                    private val hashCode: Int by lazy {
                        Objects.hash(startDate, additionalProperties)
                    }
                ...
                private constructor(
                     ...
                     *   (e.g. if the server responded with an unexpected value).
                     */
                    fun amountsOff(): Optional<List<AmountsOff>> =
                        amountsOff.getOptional("amountsOff")
                    ...
                    class Builder internal constructor() {
                         ...
                         * `List<AmountsOff>` value instead. This method is primarily for setting
                         * the field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.durationInMonths] with a well-typed
                         ...
                         *
                         * You should usually call [Builder.percentOff] with a well-typed [Double]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(amountsOff: AmountsOff) = apply {
                                ...
                                additionalProperties =
                                    amountsOff.additionalProperties.toMutableMap()
                            }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [BillingCycleAnchor]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [BillingCycleAnchor] can contain an unknown value in a couple of
                 * cases:
                ...
                enum class Value {
                    ...
                    NOW,
                    /**
                     * An enum member indicating that [BillingCycleAnchor] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
                ...
                fun known(): Known =
                    when (this) {
                        ...
                        NOW -> Known.NOW
                            ...
                            throw StiggInvalidDataException("Unknown BillingCycleAnchor: $value")
                    }
            ...
            private constructor(
                 ...
                 *
                 * Unlike [chargeOnBehalfOfAccount], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("chargeOnBehalfOfAccount")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [integrationId], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("integrationId")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [isBackdated], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("isBackdated")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [isInvoicePaid], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("isInvoicePaid")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [prorationBehavior], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("prorationBehavior")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [taxPercentage], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("taxPercentage")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [taxRateIds], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("taxRateIds")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    internal fun from(billingInformation: BillingInformation) = apply {
                        ...
                        additionalProperties =
                            billingInformation.additionalProperties.toMutableMap()
                    }
                     ...
                     *
                     * You should usually call [Builder.chargeOnBehalfOfAccount] with a well-typed
                     * [String] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    fun chargeOnBehalfOfAccount(chargeOnBehalfOfAccount: JsonField<String>) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.integrationId] with a well-typed [String]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.invoiceDaysUntilDue] with a well-typed
                     ...
                     *
                     * You should usually call [Builder.isBackdated] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /** Whether the invoice is marked as paid */
                    fun isInvoicePaid(isInvoicePaid: Boolean) =
                        isInvoicePaid(JsonField.of(isInvoicePaid))

                    /**
                     * Sets [Builder.isInvoicePaid] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.isInvoicePaid] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                    ...
                    /**
                     * Additional metadata for the subscription, stored as an arbitrary flat
                     * key-value object.
                     */
                    fun metadata(metadata: Metadata) = metadata(JsonField.of(metadata))
                     ...
                     * [ProrationBehavior] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
                    ...
                    /** Tax percentage (0-100) */
                    fun taxPercentage(taxPercentage: Double) =
                        taxPercentage(JsonField.of(taxPercentage))

                    /**
                     * Sets [Builder.taxPercentage] to an arbitrary JSON value.
                     *
                     * You should usually call [Builder.taxPercentage] with a well-typed [Double]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.taxRateIds] with a well-typed `List<String>`
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                ...
                private constructor(private val value: JsonField<String>) : Enum {
                    ...
                    /**
                     * An enum containing [ProrationBehavior]'s known values, as well as an
                     * [_UNKNOWN] member.
                     *
                     * An instance of [ProrationBehavior] can contain an unknown value in a couple
                     * of cases:
                    ...
                    enum class Value {
                        ...
                        NONE,
                        /**
                         * An enum member indicating that [ProrationBehavior] was instantiated with
                         * an unknown value.
                         */
                        _UNKNOWN,
                    }
                    ...
                    fun known(): Known =
                        when (this) {
                            ...
                            NONE -> Known.NONE
                                ...
                                throw StiggInvalidDataException("Unknown ProrationBehavior: $value")
                        }
            ...
            private constructor(
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun allowPromoCodes(): Optional<Boolean> =
                    allowPromoCodes.getOptional("allowPromoCodes")
                 ...
                 *
                 * Unlike [cancelUrl], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("cancelUrl")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [successUrl], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("successUrl")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [allowPromoCodes], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("allowPromoCodes")
                @ExcludeMissing
                 ...
                 *
                 * Unlike [collectBillingAddress], this method doesn't throw if the JSON field has
                 * an unexpected type.
                 */
                @JsonProperty("collectBillingAddress")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.cancelUrl] with a well-typed [String] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                    fun cancelUrl(cancelUrl: JsonField<String>) = apply {
                     ...
                     * not yet supported value.
                     */
                    fun successUrl(successUrl: JsonField<String>) = apply {
                     ...
                     *
                     * You should usually call [Builder.allowPromoCodes] with a well-typed [Boolean]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.allowTaxIdCollection] with a well-typed
                     * [Boolean] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.collectBillingAddress] with a well-typed
                     * [Boolean] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.collectPhoneNumber] with a well-typed
                     * [Boolean] value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
            ...
            private constructor(
                ...
                /**
                 * An interface that defines how to map each variant of [Entitlement] to a value of
                 * type [T].
                 */
                ...
                private constructor(
                    ...
                    fun monthlyResetPeriodConfiguration():
                        Optional<MonthlyResetPeriodConfiguration> =
                        monthlyResetPeriodConfiguration.getOptional(
                            "monthlyResetPeriodConfiguration"
                        )
                     ...
                     *   (e.g. if the server responded with an unexpected value).
                     */
                    fun resetPeriod(): Optional<ResetPeriod> =
                        resetPeriod.getOptional("resetPeriod")
                     ...
                     *
                     * Unlike [hasUnlimitedUsage], this method doesn't throw if the JSON field has
                     * an unexpected type.
                     */
                    @JsonProperty("hasUnlimitedUsage")
                    @ExcludeMissing
                     ...
                     *
                     * Unlike [monthlyResetPeriodConfiguration], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("monthlyResetPeriodConfiguration")
                    @ExcludeMissing
                    fun _monthlyResetPeriodConfiguration():
                        JsonField<MonthlyResetPeriodConfiguration> = monthlyResetPeriodConfiguration
                     ...
                     *
                     * Unlike [weeklyResetPeriodConfiguration], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("weeklyResetPeriodConfiguration")
                    @ExcludeMissing
                    fun _weeklyResetPeriodConfiguration():
                        JsonField<WeeklyResetPeriodConfiguration> = weeklyResetPeriodConfiguration

                    /**
                     * Returns the raw JSON value of [yearlyResetPeriodConfiguration].
                     *
                     * Unlike [yearlyResetPeriodConfiguration], this method doesn't throw if the
                     * JSON field has an unexpected type.
                     */
                    @JsonProperty("yearlyResetPeriodConfiguration")
                    @ExcludeMissing
                    fun _yearlyResetPeriodConfiguration():
                        JsonField<YearlyResetPeriodConfiguration> = yearlyResetPeriodConfiguration
                    ...
                    class Builder internal constructor() {
                        ...
                        internal fun from(feature: Feature) = apply {
                            ...
                            monthlyResetPeriodConfiguration =
                                feature.monthlyResetPeriodConfiguration
                         ...
                         * Sets [Builder.hasSoftLimit] to an arbitrary JSON value.
                         *
                         * You should usually call [Builder.hasSoftLimit] with a well-typed
                        ...
                        fun monthlyResetPeriodConfiguration(
                            ...
                            monthlyResetPeriodConfiguration(
                                monthlyResetPeriodConfiguration.getOrNull()
                            )

                        /**
                         * Sets [Builder.monthlyResetPeriodConfiguration] to an arbitrary JSON
                         * value.
                         *
                         * You should usually call [Builder.monthlyResetPeriodConfiguration] with a
                         * well-typed [MonthlyResetPeriodConfiguration] value instead. This method
                         ...
                         *
                         * You should usually call [Builder.resetPeriod] with a well-typed
                         * [ResetPeriod] value instead. This method is primarily for setting the
                         * field to an undocumented or not yet supported value.
                         */
                         ...
                         *
                         * You should usually call [Builder.usageLimit] with a well-typed [Long]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                        fun usageLimit(usageLimit: JsonField<Long>) = apply {
                        ...
                        fun weeklyResetPeriodConfiguration(
                            ...
                            weeklyResetPeriodConfiguration(
                                weeklyResetPeriodConfiguration.getOrNull()
                            )
                        ...
                        fun yearlyResetPeriodConfiguration(
                            ...
                            yearlyResetPeriodConfiguration(
                                yearlyResetPeriodConfiguration.getOrNull()
                            )
                    ...
                    internal fun validity(): Int =
                        (if (id.asKnown().isPresent) 1 else 0) +
                            ...
                            (monthlyResetPeriodConfiguration.asKnown().getOrNull()?.validity()
                                ?: 0) +
                            (resetPeriod.asKnown().getOrNull()?.validity() ?: 0) +
                            (if (usageLimit.asKnown().isPresent) 1 else 0) +
                            (weeklyResetPeriodConfiguration.asKnown().getOrNull()?.validity()
                                ?: 0) +
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(
                                ...
                                additionalProperties =
                                    monthlyResetPeriodConfiguration.additionalProperties
                                        .toMutableMap()
                            }
                        ...
                        private constructor(private val value: JsonField<String>) : Enum {
                            ...
                            /**
                             * An enum containing [AccordingTo]'s known values, as well as an
                             * [_UNKNOWN] member.
                             *
                             * An instance of [AccordingTo] can contain an unknown value in a couple
                             * of cases:
                             * - It was deserialized from data that doesn't match any known member.
                             *   For example, if the SDK is on an older version than the API, then
                             *   the API may respond with new members that the SDK is unaware of.
                            ...
                            enum class Value {
                                ...
                                START_OF_THE_MONTH,
                                /**
                                 * An enum member indicating that [AccordingTo] was instantiated
                        ...
                        fun known(): Known =
                            when (this) {
                                ...
                                HOUR -> Known.HOUR
                                    ...
                                    throw StiggInvalidDataException("Unknown ResetPeriod: $value")
                            }
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(
                                ...
                                additionalProperties =
                                    weeklyResetPeriodConfiguration.additionalProperties
                                        .toMutableMap()
                            }
                    ...
                    private constructor(
                        ...
                        class Builder internal constructor() {
                            ...
                            internal fun from(
                                ...
                                additionalProperties =
                                    yearlyResetPeriodConfiguration.additionalProperties
                                        .toMutableMap()
                            }
                    ...
                    override fun equals(other: Any?): Boolean {
                        ...
                        return other is Feature &&
                            ...
                            monthlyResetPeriodConfiguration ==
                                other.monthlyResetPeriodConfiguration &&
                            resetPeriod == other.resetPeriod &&
                            usageLimit == other.usageLimit &&
                            weeklyResetPeriodConfiguration ==
                                other.weeklyResetPeriodConfiguration &&
                            yearlyResetPeriodConfiguration ==
                                other.yearlyResetPeriodConfiguration &&
                            additionalProperties == other.additionalProperties
                    }
                ...
                private constructor(
                     ...
                     *
                     * Unlike [cadence], this method doesn't throw if the JSON field has an
                     * unexpected type.
                     */
                    @JsonProperty("cadence")
                    @ExcludeMissing
                    ...
                    class Builder internal constructor() {
                         ...
                         *
                         * You should usually call [Builder.cadence] with a well-typed [Cadence]
                         * value instead. This method is primarily for setting the field to an
                         * undocumented or not yet supported value.
                         */
                    ...
                    private constructor(private val value: JsonField<String>) : Enum {
                        ...
                        /**
                         * An enum containing [Cadence]'s known values, as well as an [_UNKNOWN]
                         * member.
                         *
                         * An instance of [Cadence] can contain an unknown value in a couple of
                         * cases:
                         * - It was deserialized from data that doesn't match any known member. For
                         *   example, if the SDK is on an older version than the API, then the API
                         *   may respond with new members that the SDK is unaware of.
                        ...
                        enum class Value {
                            ...
                            YEAR,
                            /**
                             * An enum member indicating that [Cadence] was instantiated with an
                             * unknown value.
                             */
                            _UNKNOWN,
                        }
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                /**
                 * An enum containing [ScheduleStrategy]'s known values, as well as an [_UNKNOWN]
                 * member.
                 *
                 * An instance of [ScheduleStrategy] can contain an unknown value in a couple of
                 * cases:
                 * - It was deserialized from data that doesn't match any known member. For example,
                 *   if the SDK is on an older version than the API, then the API may respond with
                 *   new members that the SDK is unaware of.
                ...
                enum class Value {
                    ...
                    IMMEDIATE,
                    /**
                     * An enum member indicating that [ScheduleStrategy] was instantiated with an
                     * unknown value.
                     */
                    _UNKNOWN,
                }
            ...
            private constructor(
                ...
                private constructor(
                    ...
                    @ExcludeMissing
                    isTrial: JsonField<Boolean> = JsonMissing.of(),
                 ...
                 *   if the server responded with an unexpected value).
                 */
                fun trialEndDate(): Optional<OffsetDateTime> =
                    trialEndDate.getOptional("trialEndDate")

                /**
                 * Returns the raw JSON value of [isTrial].
                 *
                 * Unlike [isTrial], this method doesn't throw if the JSON field has an unexpected
                 * type.
                 */
                @JsonProperty("isTrial")
                @ExcludeMissing
                fun _isTrial(): JsonField<Boolean> = isTrial
                 ...
                 *
                 * Unlike [trialEndDate], this method doesn't throw if the JSON field has an
                 * unexpected type.
                 */
                @JsonProperty("trialEndDate")
                @ExcludeMissing
                ...
                class Builder internal constructor() {
                    ...
                    @JvmSynthetic
                    internal fun from(trialOverrideConfiguration: TrialOverrideConfiguration) =
                        apply {
                     ...
                     *
                     * You should usually call [Builder.isTrial] with a well-typed [Boolean] value
                     * instead. This method is primarily for setting the field to an undocumented or
                     * not yet supported value.
                     */
                     ...
                     *
                     * You should usually call [Builder.trialEndDate] with a well-typed
                     * [OffsetDateTime] value instead. This method is primarily for setting the
                     * field to an undocumented or not yet supported value.
                     */
            ...
            override fun equals(other: Any?): Boolean {
                ...
                return other is NewSubscription &&
                    customerId == other.customerId &&
                    planId == other.planId &&
                    id == other.id &&
                    addons == other.addons &&
        ...
        override fun equals(other: Any?): Boolean {
            ...
            return other is Subscription &&
                existingSubscriptionId == other.existingSubscriptionId &&
                newSubscription == other.newSubscription &&
                additionalProperties == other.additionalProperties
        }

        private val hashCode: Int by lazy {
            Objects.hash(existingSubscriptionId, newSubscription, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Subscription{existingSubscriptionId=$existingSubscriptionId, newSubscription=$newSubscription, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "ContractCreateParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
