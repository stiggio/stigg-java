...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractDeleteResponse].
         *
    ...
    /** A builder for [ContractDeleteResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractDeleteResponse: ContractDeleteResponse) = apply {
            data = contractDeleteResponse.data
            additionalProperties = contractDeleteResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContractDeleteResponse].
         *
         ...
         */
        fun build(): ContractDeleteResponse =
            ContractDeleteResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): ContractDeleteResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContractDeleteResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ContractDeleteResponse{data=$data, additionalProperties=$additionalProperties}"
}
