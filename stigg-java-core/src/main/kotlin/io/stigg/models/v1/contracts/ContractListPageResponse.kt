...
private constructor(
    private val data: JsonField<List<ContractListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ContractListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ContractListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<ContractListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<ContractListResponse>>? = null
        ...
        internal fun from(contractListPageResponse: ContractListPageResponse) = apply {
            ...
            pagination = contractListPageResponse.pagination
            additionalProperties = contractListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<ContractListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<ContractListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<ContractListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ContractListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ContractListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "ContractListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
