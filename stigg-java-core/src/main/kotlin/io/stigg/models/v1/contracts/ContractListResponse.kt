...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("poNumber") @ExcludeMissing poNumber: JsonField<String> = JsonMissing.of(),
    ...
    /**
     * The most recent non-draft invoice for this contract (open, paid, or canceled), or null when
     * none exists
     *
     * @throws StiggInvalidDataException if the JSON field has an unexpected type (e.g. if the
     *   server responded with an unexpected value).
     ...
     *
     * Unlike [billingState], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("billingState")
    @ExcludeMissing
    ...
    class Builder internal constructor() {
        ...
        internal fun from(contractListResponse: ContractListResponse) = apply {
            id = contractListResponse.id
            activationEndDate = contractListResponse.activationEndDate
            activationStartDate = contractListResponse.activationStartDate
            billingId = contractListResponse.billingId
            billingState = contractListResponse.billingState
            contractId = contractListResponse.contractId
            createdAt = contractListResponse.createdAt
            customerExternalId = contractListResponse.customerExternalId
            externalId = contractListResponse.externalId
            latestInvoice = contractListResponse.latestInvoice
            name = contractListResponse.name
            nextInvoice = contractListResponse.nextInvoice
            poNumber = contractListResponse.poNumber
            refId = contractListResponse.refId
            state = contractListResponse.state
            subscriptions = contractListResponse.subscriptions.map { it.toMutableList() }
        ...
        /**
         * Alias for calling [Builder.activationStartDate] with `activationStartDate.orElse(null)`.
         */
        ...
        /** A preview of the contract's upcoming invoice, or null when none is available */
        fun nextInvoice(nextInvoice: NextInvoice?) = nextInvoice(JsonField.ofNullable(nextInvoice))

        /** Alias for calling [Builder.nextInvoice] with `nextInvoice.orElse(null)`. */
        fun nextInvoice(nextInvoice: Optional<NextInvoice>) = nextInvoice(nextInvoice.getOrNull())
         ...
         *
         * You should usually call [Builder.refId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    class BillingState @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        enum class Value {
            ...
            END_BILLING,
            /**
             * An enum member indicating that [BillingState] was instantiated with an unknown value.
             */
            _UNKNOWN,
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            /** The end of the billing period the upcoming invoice covers */
            fun periodEnd(periodEnd: OffsetDateTime?) = periodEnd(JsonField.ofNullable(periodEnd))
        ...
        private val hashCode: Int by lazy {
            Objects.hash(amount, dueDate, invoiceId, periodEnd, periodStart, additionalProperties)
        }
    ...
    private constructor(
         ...
         *
         * Unlike [planDisplayName], this method doesn't throw if the JSON field has an unexpected
         * type.
         */
        @JsonProperty("planDisplayName")
        @ExcludeMissing
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.planDisplayName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
             ...
             *
             * You should usually call [Builder.productDisplayName] with a well-typed [String] value
             * instead. This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
        ...
        private val hashCode: Int by lazy {
            Objects.hash(planDisplayName, productDisplayName, subscriptionId, additionalProperties)
        }
