...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ContractUpdateResponse].
         *
    ...
    /** A builder for [ContractUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(contractUpdateResponse: ContractUpdateResponse) = apply {
            data = contractUpdateResponse.data
            additionalProperties = contractUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ContractUpdateResponse].
         *
         ...
         */
        fun build(): ContractUpdateResponse =
            ContractUpdateResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): ContractUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ContractUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ContractUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
