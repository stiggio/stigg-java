...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CouponRetrieveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CouponRetrieveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CouponRetrieveParams]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [CouponRetrieveParams].
         *
