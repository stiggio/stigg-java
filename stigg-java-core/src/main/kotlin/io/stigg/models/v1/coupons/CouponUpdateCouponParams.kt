...
class CouponUpdateCouponParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CouponUpdateCouponParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [CouponUpdateCouponParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CouponUpdateCouponParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(couponUpdateCouponParams: CouponUpdateCouponParams) = apply {
            id = couponUpdateCouponParams.id
            xAccountId = couponUpdateCouponParams.xAccountId
            xEnvironmentId = couponUpdateCouponParams.xEnvironmentId
            body = couponUpdateCouponParams.body.toBuilder()
            additionalHeaders = couponUpdateCouponParams.additionalHeaders.toBuilder()
            additionalQueryParams = couponUpdateCouponParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CouponUpdateCouponParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CouponUpdateCouponParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CouponUpdateCouponParams &&
            id == other.id &&
    ...
    override fun toString() =
        "CouponUpdateCouponParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
