...
/** Response object */
class CreditGetAutoRechargeResponse
...
private constructor(
    ...
    /** A builder for [CreditGetAutoRechargeResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditGetAutoRechargeResponse: CreditGetAutoRechargeResponse) = apply {
            data = creditGetAutoRechargeResponse.data
            additionalProperties = creditGetAutoRechargeResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CreditGetAutoRechargeResponse].
         *
         ...
         */
        fun build(): CreditGetAutoRechargeResponse =
            CreditGetAutoRechargeResponse(
     ...
     *   type.
     */
    fun validate(): CreditGetAutoRechargeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditGetAutoRechargeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CreditGetAutoRechargeResponse{data=$data, additionalProperties=$additionalProperties}"
}
