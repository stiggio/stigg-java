...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomCurrency].
         *
    ...
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrency: CustomCurrency) = apply {
            data = customCurrency.data
            additionalProperties = customCurrency.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrency].
         *
         ...
         */
        fun build(): CustomCurrency =
            CustomCurrency(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): CustomCurrency = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrency &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrency{data=$data, additionalProperties=$additionalProperties}"
}
