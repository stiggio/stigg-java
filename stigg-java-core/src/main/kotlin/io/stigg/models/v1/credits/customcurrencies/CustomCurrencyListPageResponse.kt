...
class CustomCurrencyListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CustomCurrencyListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CustomCurrencyListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CustomCurrencyListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CustomCurrencyListResponse>> = data
    ...
    /** A builder for [CustomCurrencyListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CustomCurrencyListResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(customCurrencyListPageResponse: CustomCurrencyListPageResponse) = apply {
            data = customCurrencyListPageResponse.data.map { it.toMutableList() }
            pagination = customCurrencyListPageResponse.pagination
            additionalProperties =
                customCurrencyListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CustomCurrencyListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<CustomCurrencyListResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<CustomCurrencyListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CustomCurrencyListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CustomCurrencyListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyListPageResponse].
         *
         ...
         */
        fun build(): CustomCurrencyListPageResponse =
            CustomCurrencyListPageResponse(
     ...
     *   type.
     */
    fun validate(): CustomCurrencyListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CustomCurrencyListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
