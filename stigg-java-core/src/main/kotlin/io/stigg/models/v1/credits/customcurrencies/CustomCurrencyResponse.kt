...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomCurrencyResponse].
         *
    ...
    /** A builder for [CustomCurrencyResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyResponse: CustomCurrencyResponse) = apply {
            data = customCurrencyResponse.data
            additionalProperties = customCurrencyResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyResponse].
         *
         ...
         */
        fun build(): CustomCurrencyResponse =
            CustomCurrencyResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }
     ...
     *   type.
     */
    fun validate(): CustomCurrencyResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, archivedAt=$archivedAt, createdAt=$createdAt, description=$description, displayName=$displayName, metadata=$metadata, symbol=$symbol, units=$units, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrencyResponse{data=$data, additionalProperties=$additionalProperties}"
}
