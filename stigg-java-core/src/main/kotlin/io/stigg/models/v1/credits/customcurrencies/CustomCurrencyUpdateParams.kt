...
class CustomCurrencyUpdateParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CustomCurrencyUpdateParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [CustomCurrencyUpdateParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CustomCurrencyUpdateParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyUpdateParams: CustomCurrencyUpdateParams) = apply {
            currencyId = customCurrencyUpdateParams.currencyId
            xAccountId = customCurrencyUpdateParams.xAccountId
            xEnvironmentId = customCurrencyUpdateParams.xEnvironmentId
            body = customCurrencyUpdateParams.body.toBuilder()
            additionalHeaders = customCurrencyUpdateParams.additionalHeaders.toBuilder()
            additionalQueryParams = customCurrencyUpdateParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyUpdateParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CustomCurrencyUpdateParams =
    ...
    private constructor(
        ...
        ) : this(description, displayName, metadata, symbol, units, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(description, displayName, metadata, symbol, units, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{description=$description, displayName=$displayName, metadata=$metadata, symbol=$symbol, units=$units, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyUpdateParams &&
    ...
    override fun toString() =
        "CustomCurrencyUpdateParams{currencyId=$currencyId, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
