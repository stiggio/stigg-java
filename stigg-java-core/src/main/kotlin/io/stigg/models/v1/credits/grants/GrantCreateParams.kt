...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(grantCreateParams: GrantCreateParams) = apply {
            xAccountId = grantCreateParams.xAccountId
            xEnvironmentId = grantCreateParams.xEnvironmentId
    ...
    override fun toString() =
        "GrantCreateParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
