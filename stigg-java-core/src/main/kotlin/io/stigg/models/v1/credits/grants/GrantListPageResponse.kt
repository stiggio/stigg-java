...
private constructor(
    private val data: JsonField<List<GrantListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<GrantListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<GrantListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<GrantListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<GrantListResponse>>? = null
        ...
        internal fun from(grantListPageResponse: GrantListPageResponse) = apply {
            data = grantListPageResponse.data.map { it.toMutableList() }
            pagination = grantListPageResponse.pagination
            additionalProperties = grantListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<GrantListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<GrantListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<GrantListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [GrantListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: GrantListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "GrantListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
