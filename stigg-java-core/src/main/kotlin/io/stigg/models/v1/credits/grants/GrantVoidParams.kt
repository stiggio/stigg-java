...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): GrantVoidParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [GrantVoidParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [GrantVoidParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(grantVoidParams: GrantVoidParams) = apply {
            id = grantVoidParams.id
            xAccountId = grantVoidParams.xAccountId
            xEnvironmentId = grantVoidParams.xEnvironmentId
            additionalHeaders = grantVoidParams.additionalHeaders.toBuilder()
            additionalQueryParams = grantVoidParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = grantVoidParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [GrantVoidParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): GrantVoidParams =
            GrantVoidParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is GrantVoidParams &&
            id == other.id &&
    ...
    override fun toString() =
        "GrantVoidParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
