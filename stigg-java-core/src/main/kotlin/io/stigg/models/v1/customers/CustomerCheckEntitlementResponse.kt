...
/** Response object */
class CustomerCheckEntitlementResponse
...
private constructor(
    ...
    /** A builder for [CustomerCheckEntitlementResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerCheckEntitlementResponse: CustomerCheckEntitlementResponse) =
            apply {
                data = customerCheckEntitlementResponse.data
                additionalProperties =
                    customerCheckEntitlementResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomerCheckEntitlementResponse].
         *
         ...
         */
        fun build(): CustomerCheckEntitlementResponse =
            CustomerCheckEntitlementResponse(
     ...
     *   type.
     */
    fun validate(): CustomerCheckEntitlementResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerCheckEntitlementResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomerCheckEntitlementResponse{data=$data, additionalProperties=$additionalProperties}"
}
