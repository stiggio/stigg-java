...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerImportParams: CustomerImportParams) = apply {
            xAccountId = customerImportParams.xAccountId
            xEnvironmentId = customerImportParams.xEnvironmentId
    ...
    override fun toString() =
        "CustomerImportParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
