...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): CustomerListContractsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [CustomerListContractsParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [CustomerListContractsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerListContractsParams: CustomerListContractsParams) = apply {
            id = customerListContractsParams.id
            xAccountId = customerListContractsParams.xAccountId
            xEnvironmentId = customerListContractsParams.xEnvironmentId
            additionalHeaders = customerListContractsParams.additionalHeaders.toBuilder()
            additionalQueryParams = customerListContractsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerListContractsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): CustomerListContractsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerListContractsParams &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerListContractsParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
