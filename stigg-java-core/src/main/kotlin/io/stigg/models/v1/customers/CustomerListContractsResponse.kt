...
class CustomerListContractsResponse
...
private constructor(
    ...
    /** A builder for [CustomerListContractsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerListContractsResponse: CustomerListContractsResponse) = apply {
            data = customerListContractsResponse.data.map { it.toMutableList() }
            additionalProperties = customerListContractsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerListContractsResponse].
         *
         ...
         */
        fun build(): CustomerListContractsResponse =
            CustomerListContractsResponse(
     ...
     *   type.
     */
    fun validate(): CustomerListContractsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerListContractsResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomerListContractsResponse{data=$data, additionalProperties=$additionalProperties}"
}
