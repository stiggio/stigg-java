...
class CustomerListInvoicesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CustomerListInvoicesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CustomerListInvoicesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CustomerListInvoicesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CustomerListInvoicesResponse>> = data
    ...
    /** A builder for [CustomerListInvoicesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CustomerListInvoicesResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(customerListInvoicesPageResponse: CustomerListInvoicesPageResponse) =
            apply {
                data = customerListInvoicesPageResponse.data.map { it.toMutableList() }
                pagination = customerListInvoicesPageResponse.pagination
                additionalProperties =
                    customerListInvoicesPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<CustomerListInvoicesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<CustomerListInvoicesResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<CustomerListInvoicesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CustomerListInvoicesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CustomerListInvoicesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CustomerListInvoicesPageResponse].
         *
         ...
         */
        fun build(): CustomerListInvoicesPageResponse =
            CustomerListInvoicesPageResponse(
     ...
     *   type.
     */
    fun validate(): CustomerListInvoicesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerListInvoicesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CustomerListInvoicesPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
