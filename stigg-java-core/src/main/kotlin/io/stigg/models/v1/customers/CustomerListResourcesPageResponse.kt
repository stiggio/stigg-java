...
class CustomerListResourcesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<CustomerListResourcesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CustomerListResourcesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CustomerListResourcesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CustomerListResourcesResponse>> = data
    ...
    /** A builder for [CustomerListResourcesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CustomerListResourcesResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(customerListResourcesPageResponse: CustomerListResourcesPageResponse) =
            apply {
                data = customerListResourcesPageResponse.data.map { it.toMutableList() }
                pagination = customerListResourcesPageResponse.pagination
                additionalProperties =
                    customerListResourcesPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<CustomerListResourcesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<CustomerListResourcesResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<CustomerListResourcesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CustomerListResourcesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CustomerListResourcesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CustomerListResourcesPageResponse].
         *
         ...
         */
        fun build(): CustomerListResourcesPageResponse =
            CustomerListResourcesPageResponse(
     ...
     *   type.
     */
    fun validate(): CustomerListResourcesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerListResourcesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CustomerListResourcesPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
