...
private constructor(
    ...
    /** A builder for [CustomerListResourcesResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customerListResourcesResponse: CustomerListResourcesResponse) = apply {
            id = customerListResourcesResponse.id
            createdAt = customerListResourcesResponse.createdAt
            updatedAt = customerListResourcesResponse.updatedAt
            additionalProperties = customerListResourcesResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerListResourcesResponse].
         *
         ...
         */
        fun build(): CustomerListResourcesResponse =
            CustomerListResourcesResponse(
                checkRequired("id", id),
     ...
     *   type.
     */
    fun validate(): CustomerListResourcesResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerListResourcesResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "CustomerListResourcesResponse{id=$id, createdAt=$createdAt, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
