...
private constructor(
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{id=$id, billingCurrency=$billingCurrency, billingId=$billingId, couponId=$couponId, defaultPaymentMethod=$defaultPaymentMethod, email=$email, integrations=$integrations, metadata=$metadata, name=$name, additionalProperties=$additionalProperties}"
    }
