...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun couponId(): Optional<CouponId> = body.couponId()
     ...
     */
    fun _couponId(): JsonField<CouponId> = body._couponId()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(customerProvisionParams: CustomerProvisionParams) = apply {
            xAccountId = customerProvisionParams.xAccountId
            xEnvironmentId = customerProvisionParams.xEnvironmentId
        ...
        /** Customer level coupon */
        fun couponId(couponId: CouponId?) = apply { body.couponId(couponId) }
         ...
         *
         * You should usually call [Builder.couponId] with a well-typed [CouponId] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        fun couponId(couponId: JsonField<CouponId>) = apply { body.couponId(couponId) }

        /**
         * Sets [couponId] to an arbitrary [String].
         *
         * You should usually call [couponId] with a well-typed [CouponId] constant instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun couponId(value: String) = apply { body.couponId(value) }
    ...
    private constructor(
        ...
        override fun toString() =
            "Body{id=$id, billingCurrency=$billingCurrency, billingId=$billingId, couponId=$couponId, defaultPaymentMethod=$defaultPaymentMethod, email=$email, integrations=$integrations, language=$language, metadata=$metadata, name=$name, passthrough=$passthrough, timezone=$timezone, additionalProperties=$additionalProperties}"
    }
    ...
    /** Customer level coupon */
    class CouponId @JsonCreator private constructor(private val value: JsonField<String>) : Enum {
    ...
    override fun toString() =
        "CustomerProvisionParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
