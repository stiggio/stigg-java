...
/** Response object */
class CustomerRetrieveEntitlementsResponse
...
private constructor(
    ...
    /** A builder for [CustomerRetrieveEntitlementsResponse]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            additionalProperties =
                customerRetrieveEntitlementsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomerRetrieveEntitlementsResponse].
         *
         ...
         */
        fun build(): CustomerRetrieveEntitlementsResponse =
            CustomerRetrieveEntitlementsResponse(
    ...
    fun validate(): CustomerRetrieveEntitlementsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        ) : this(accessDeniedReason, entitlements, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * [AccessDeniedReason] value instead. This method is primarily for setting the field to
        ...
        private constructor(private val value: JsonField<String>) : Enum {
            ...
            fun known(): Known =
                when (this) {
                    ...
                    else -> throw StiggInvalidDataException("Unknown AccessDeniedReason: $value")
                }
        ...
        private constructor(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                     ...
                     *
                     * You should usually call [Builder.feature] with a well-typed [InnerFeature]
                     * value instead. This method is primarily for setting the field to an
                     * undocumented or not yet supported value.
                     */
                ...
                private constructor(
                    ...
                    override fun toString() =
                        "InnerFeature{displayName=$displayName, featureStatus=$featureStatus, featureType=$featureType, refId=$refId, additionalProperties=$additionalProperties}"
                }
        ...
        private val hashCode: Int by lazy {
            Objects.hash(accessDeniedReason, entitlements, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Data{accessDeniedReason=$accessDeniedReason, entitlements=$entitlements, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomerRetrieveEntitlementsResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomerRetrieveEntitlementsResponse{data=$data, additionalProperties=$additionalProperties}"
}
