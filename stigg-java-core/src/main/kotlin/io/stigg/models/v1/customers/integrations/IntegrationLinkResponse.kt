...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationLinkResponse].
         *
    ...
    /** A builder for [IntegrationLinkResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(integrationLinkResponse: IntegrationLinkResponse) = apply {
            data = integrationLinkResponse.data
            additionalProperties = integrationLinkResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationLinkResponse].
         *
         ...
         */
        fun build(): IntegrationLinkResponse =
    ...
    fun validate(): IntegrationLinkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationLinkResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "IntegrationLinkResponse{data=$data, additionalProperties=$additionalProperties}"
}
