...
class IntegrationListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<IntegrationListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<IntegrationListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<IntegrationListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<IntegrationListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationListPageResponse].
         *
    ...
    /** A builder for [IntegrationListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<IntegrationListResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(integrationListPageResponse: IntegrationListPageResponse) = apply {
            data = integrationListPageResponse.data.map { it.toMutableList() }
            pagination = integrationListPageResponse.pagination
            additionalProperties = integrationListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<IntegrationListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<IntegrationListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<IntegrationListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [IntegrationListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: IntegrationListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [IntegrationListPageResponse].
         *
         ...
         */
        fun build(): IntegrationListPageResponse =
            IntegrationListPageResponse(
     ...
     *   type.
     */
    fun validate(): IntegrationListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "IntegrationListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
