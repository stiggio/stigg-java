...
private constructor(
    ...
    private constructor(
        ...
        @JsonProperty("syncData") @ExcludeMissing syncData: JsonField<SyncData> = JsonMissing.of(),
    ...
    class Builder internal constructor() {
        ...
        internal fun from(integrationListResponse: IntegrationListResponse) = apply {
            id = integrationListResponse.id
            syncedEntityId = integrationListResponse.syncedEntityId
            vendorIdentifier = integrationListResponse.vendorIdentifier
            syncData = integrationListResponse.syncData
         ...
         *
         * You should usually call [Builder.syncData] with a well-typed [SyncData] value instead.
        ...
        /**
         * Alias for calling [syncData] with `SyncData.ofRevisionMarketplace(revisionMarketplace)`.
         */
    ...
    private constructor(
        ...
        fun <T> accept(visitor: Visitor<T>): T =
            when {
                ...
                revisionMarketplace != null -> visitor.visitRevisionMarketplace(revisionMarketplace)
        ...
        fun validate(): SyncData = apply {
            ...
            accept(
                object : Visitor<Unit> {
                    ...
                    override fun visitRevisionBilling(revisionBilling: SyncRevisionBillingData) {
        ...
        override fun toString(): String =
            when {
                ...
                revisionMarketplace != null -> "SyncData{revisionMarketplace=$revisionMarketplace}"
        ...
        /**
         * An interface that defines how to map each variant of [SyncData] to a value of type [T].
         */
        interface Visitor<out T> {
             ...
             *
             * An instance of [SyncData] can contain an unknown variant if it was deserialized from
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): SyncData {
                ...
                val bestMatches =
                    sequenceOf(
                            ...
                            tryDeserialize(node, jacksonTypeRef<SyncRevisionBillingData>())?.let {
                                SyncData(revisionBilling = it, _json = json)
                            },
        ...
        internal class Serializer : BaseSerializer<SyncData>(SyncData::class) {
            ...
            override fun serialize(
                ...
                when {
                    ...
                    value.revisionBilling != null -> generator.writeObject(value.revisionBilling)
        ...
        private constructor(
             ...
             *
             * Unlike [priceGroupPackageBillingId], this method doesn't throw if the JSON field has
             * an unexpected type.
             */
            @JsonProperty("priceGroupPackageBillingId")
            @ExcludeMissing
            ...
            class Builder internal constructor() {
                 ...
                 *
                 * You should usually call [Builder.priceGroupPackageBillingId] with a well-typed
    ...
    override fun toString() =
        "IntegrationListResponse{id=$id, syncedEntityId=$syncedEntityId, vendorIdentifier=$vendorIdentifier, syncData=$syncData, additionalProperties=$additionalProperties}"
}
