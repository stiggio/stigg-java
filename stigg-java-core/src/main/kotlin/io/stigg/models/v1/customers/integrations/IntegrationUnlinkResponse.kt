...
/** Response object */
class IntegrationUnlinkResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [IntegrationUnlinkResponse].
         *
    ...
    /** A builder for [IntegrationUnlinkResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(integrationUnlinkResponse: IntegrationUnlinkResponse) = apply {
            data = integrationUnlinkResponse.data
            additionalProperties = integrationUnlinkResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [IntegrationUnlinkResponse].
         *
         ...
         */
        fun build(): IntegrationUnlinkResponse =
    ...
    fun validate(): IntegrationUnlinkResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is IntegrationUnlinkResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "IntegrationUnlinkResponse{data=$data, additionalProperties=$additionalProperties}"
}
