...
private constructor(
     ...
     */
    fun syncedEntityId(): Optional<String> = body.syncedEntityId()
    ...
    private constructor(
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (syncedEntityId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(syncedEntityId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{syncedEntityId=$syncedEntityId, additionalProperties=$additionalProperties}"
    }
