...
class PromotionalEntitlementListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<PromotionalEntitlementListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PromotionalEntitlementListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PromotionalEntitlementListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PromotionalEntitlementListResponse>> = data
    ...
    /** A builder for [PromotionalEntitlementListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PromotionalEntitlementListResponse>>? = null
        ...
        internal fun from(
            ...
            data = promotionalEntitlementListPageResponse.data.map { it.toMutableList() }
            pagination = promotionalEntitlementListPageResponse.pagination
            additionalProperties =
                promotionalEntitlementListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<PromotionalEntitlementListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<PromotionalEntitlementListResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<PromotionalEntitlementListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PromotionalEntitlementListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PromotionalEntitlementListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PromotionalEntitlementListPageResponse].
         *
         ...
         */
        fun build(): PromotionalEntitlementListPageResponse =
            PromotionalEntitlementListPageResponse(
    ...
    fun validate(): PromotionalEntitlementListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalEntitlementListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PromotionalEntitlementListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
