...
class PromotionalEntitlementListParams
private constructor(
    ...
    /**
     * Filter by promotional entitlement status. Supports comma-separated values for multiple
     * statuses
     */
    ...
    companion object {
        ...
        @JvmStatic fun none(): PromotionalEntitlementListParams = builder().build()
    ...
    /** A builder for [PromotionalEntitlementListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promotionalEntitlementListParams: PromotionalEntitlementListParams) =
            apply {
                id = promotionalEntitlementListParams.id
                after = promotionalEntitlementListParams.after
                before = promotionalEntitlementListParams.before
                createdAt = promotionalEntitlementListParams.createdAt
                limit = promotionalEntitlementListParams.limit
                status = promotionalEntitlementListParams.status?.toMutableList()
                xAccountId = promotionalEntitlementListParams.xAccountId
                xEnvironmentId = promotionalEntitlementListParams.xEnvironmentId
                additionalHeaders = promotionalEntitlementListParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    promotionalEntitlementListParams.additionalQueryParams.toBuilder()
            }
        ...
        /**
         * Returns an immutable instance of [PromotionalEntitlementListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PromotionalEntitlementListParams =
            PromotionalEntitlementListParams(
                id,
                after,
                before,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalEntitlementListParams &&
            id == other.id &&
            after == other.after &&
            before == other.before &&
    ...
    override fun toString() =
        "PromotionalEntitlementListParams{id=$id, after=$after, before=$before, createdAt=$createdAt, limit=$limit, status=$status, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
