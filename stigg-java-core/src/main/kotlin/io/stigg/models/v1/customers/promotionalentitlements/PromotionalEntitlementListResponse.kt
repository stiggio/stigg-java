...
private constructor(
     ...
     *   server responded with an unexpected value).
     */
    fun featureGroupIds(): Optional<List<String>> = featureGroupIds.getOptional("featureGroupIds")
     ...
     *   server responded with an unexpected value).
     */
    fun hasUnlimitedUsage(): Optional<Boolean> = hasUnlimitedUsage.getOptional("hasUnlimitedUsage")
     ...
     *
     * Unlike [featureGroupIds], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("featureGroupIds")
    @ExcludeMissing
     ...
     *
     * Unlike [hasSoftLimit], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("hasSoftLimit")
    @ExcludeMissing
    ...
    @JsonProperty("resetPeriodConfiguration")
    @ExcludeMissing
    fun _resetPeriodConfiguration(): JsonField<ResetPeriodConfiguration> = resetPeriodConfiguration
    ...
    /** A builder for [PromotionalEntitlementListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(promotionalEntitlementListResponse: PromotionalEntitlementListResponse) =
            apply {
                id = promotionalEntitlementListResponse.id
                createdAt = promotionalEntitlementListResponse.createdAt
                description = promotionalEntitlementListResponse.description
                endDate = promotionalEntitlementListResponse.endDate
                enumValues =
                    promotionalEntitlementListResponse.enumValues.map { it.toMutableList() }
                environmentId = promotionalEntitlementListResponse.environmentId
                featureGroupIds =
                    promotionalEntitlementListResponse.featureGroupIds.map { it.toMutableList() }
                featureId = promotionalEntitlementListResponse.featureId
                hasSoftLimit = promotionalEntitlementListResponse.hasSoftLimit
                hasUnlimitedUsage = promotionalEntitlementListResponse.hasUnlimitedUsage
                isVisible = promotionalEntitlementListResponse.isVisible
                period = promotionalEntitlementListResponse.period
                resetPeriod = promotionalEntitlementListResponse.resetPeriod
                resetPeriodConfiguration =
                    promotionalEntitlementListResponse.resetPeriodConfiguration
                startDate = promotionalEntitlementListResponse.startDate
                status = promotionalEntitlementListResponse.status
                updatedAt = promotionalEntitlementListResponse.updatedAt
                usageLimit = promotionalEntitlementListResponse.usageLimit
                additionalProperties =
                    promotionalEntitlementListResponse.additionalProperties.toMutableMap()
            }
         ...
         *
         * You should usually call [Builder.featureGroupIds] with a well-typed `List<String>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        ...
        /** Whether the entitlement has a soft limit */
        fun hasSoftLimit(hasSoftLimit: Boolean?) = hasSoftLimit(JsonField.ofNullable(hasSoftLimit))
        ...
        fun hasSoftLimit(hasSoftLimit: Optional<Boolean>) = hasSoftLimit(hasSoftLimit.getOrNull())

        /**
         * Sets [Builder.hasSoftLimit] to an arbitrary JSON value.
         *
         * You should usually call [Builder.hasSoftLimit] with a well-typed [Boolean] value instead.
         * This method is primarily for setting the field to an undocumented or not yet supported
         * value.
         */
        ...
        /** The reset period of the entitlement */
        fun resetPeriod(resetPeriod: ResetPeriod?) = resetPeriod(JsonField.ofNullable(resetPeriod))

        /** Alias for calling [Builder.resetPeriod] with `resetPeriod.orElse(null)`. */
        fun resetPeriod(resetPeriod: Optional<ResetPeriod>) = resetPeriod(resetPeriod.getOrNull())
         ...
         */
        fun resetPeriodConfiguration(resetPeriodConfiguration: Optional<ResetPeriodConfiguration>) =
         ...
         * [ResetPeriodConfiguration] value instead. This method is primarily for setting the field
        ...
        /**
         * Returns an immutable instance of [PromotionalEntitlementListResponse].
         *
         ...
         */
        fun build(): PromotionalEntitlementListResponse =
            PromotionalEntitlementListResponse(
                checkRequired("id", id),
    ...
    fun validate(): PromotionalEntitlementListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    class ResetPeriod @JsonCreator private constructor(private val value: JsonField<String>) :
        ...
        enum class Value {
            ...
            HOUR,
            /**
             * An enum member indicating that [ResetPeriod] was instantiated with an unknown value.
             */
            _UNKNOWN,
        }
    ...
    private constructor(
        ...
        override fun hashCode(): Int =
            Objects.hash(yearlyResetPeriodConfig, monthlyResetPeriodConfig, weeklyResetPeriodConfig)
        ...
        interface Visitor<out T> {
            ...
            /** Yearly reset configuration */
            fun visitYearlyResetPeriodConfig(yearlyResetPeriodConfig: YearlyResetPeriodConfig): T

            /** Monthly reset configuration */
            fun visitMonthlyResetPeriodConfig(monthlyResetPeriodConfig: MonthlyResetPeriodConfig): T

            /** Weekly reset configuration */
            fun visitWeeklyResetPeriodConfig(weeklyResetPeriodConfig: WeeklyResetPeriodConfig): T

            /**
             * Maps an unknown variant of [ResetPeriodConfiguration] to a value of type [T].
             *
             * An instance of [ResetPeriodConfiguration] can contain an unknown variant if it was
        ...
        internal class Deserializer :
            ...
            override fun ObjectCodec.deserialize(node: JsonNode): ResetPeriodConfiguration {
                ...
                val bestMatches =
                    sequenceOf(
                            tryDeserialize(node, jacksonTypeRef<YearlyResetPeriodConfig>())?.let {
                                ResetPeriodConfiguration(yearlyResetPeriodConfig = it, _json = json)
                            },
                            tryDeserialize(node, jacksonTypeRef<MonthlyResetPeriodConfig>())?.let {
                                ResetPeriodConfiguration(
                                    monthlyResetPeriodConfig = it,
                                    _json = json,
                                )
                            },
                            tryDeserialize(node, jacksonTypeRef<WeeklyResetPeriodConfig>())?.let {
                                ResetPeriodConfiguration(weeklyResetPeriodConfig = it, _json = json)
                            },
                        )
                        .filterNotNull()
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalEntitlementListResponse &&
            id == other.id &&
