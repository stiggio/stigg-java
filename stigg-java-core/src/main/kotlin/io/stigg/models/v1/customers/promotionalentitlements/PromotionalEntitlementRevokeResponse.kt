...
/** Response object */
class PromotionalEntitlementRevokeResponse
...
private constructor(
    ...
    /** A builder for [PromotionalEntitlementRevokeResponse]. */
    class Builder internal constructor() {
        ...
        /**
         * Returns an immutable instance of [PromotionalEntitlementRevokeResponse].
         *
         ...
         */
        fun build(): PromotionalEntitlementRevokeResponse =
            PromotionalEntitlementRevokeResponse(
    ...
    fun validate(): PromotionalEntitlementRevokeResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PromotionalEntitlementRevokeResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PromotionalEntitlementRevokeResponse{data=$data, additionalProperties=$additionalProperties}"
}
