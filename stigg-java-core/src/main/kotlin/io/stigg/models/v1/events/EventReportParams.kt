...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EventReportParams].
         *
    ...
    /** A builder for [EventReportParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(eventReportParams: EventReportParams) = apply {
            xAccountId = eventReportParams.xAccountId
            xEnvironmentId = eventReportParams.xEnvironmentId
            body = eventReportParams.body.toBuilder()
            additionalHeaders = eventReportParams.additionalHeaders.toBuilder()
            additionalQueryParams = eventReportParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EventReportParams].
         *
    ...
    private constructor(
        ...
        override fun toString() =
            "Event{customerId=$customerId, eventName=$eventName, idempotencyKey=$idempotencyKey, dimensions=$dimensions, resourceId=$resourceId, timestamp=$timestamp, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EventReportParams &&
    ...
    override fun toString() =
        "EventReportParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
