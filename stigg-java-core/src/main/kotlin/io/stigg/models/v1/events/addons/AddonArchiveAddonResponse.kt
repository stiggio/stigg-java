...
/** Response object */
class AddonArchiveAddonResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonArchiveAddonResponse].
         *
    ...
    /** A builder for [AddonArchiveAddonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonArchiveAddonResponse: AddonArchiveAddonResponse) = apply {
            data = addonArchiveAddonResponse.data
            additionalProperties = addonArchiveAddonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonArchiveAddonResponse].
         *
         ...
         */
        fun build(): AddonArchiveAddonResponse =
    ...
    fun validate(): AddonArchiveAddonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonArchiveAddonResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonArchiveAddonResponse{data=$data, additionalProperties=$additionalProperties}"
}
