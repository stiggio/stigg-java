...
/** Response object */
class AddonCreateAddonResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonCreateAddonResponse].
         *
    ...
    /** A builder for [AddonCreateAddonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonCreateAddonResponse: AddonCreateAddonResponse) = apply {
            data = addonCreateAddonResponse.data
            additionalProperties = addonCreateAddonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonCreateAddonResponse].
         *
         ...
         */
        fun build(): AddonCreateAddonResponse =
    ...
    fun validate(): AddonCreateAddonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonCreateAddonResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonCreateAddonResponse{data=$data, additionalProperties=$additionalProperties}"
}
