...
class AddonListAddonsPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AddonListAddonsResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AddonListAddonsResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AddonListAddonsResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AddonListAddonsResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonListAddonsPageResponse].
         *
    ...
    /** A builder for [AddonListAddonsPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AddonListAddonsResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(addonListAddonsPageResponse: AddonListAddonsPageResponse) = apply {
            data = addonListAddonsPageResponse.data.map { it.toMutableList() }
            pagination = addonListAddonsPageResponse.pagination
            additionalProperties = addonListAddonsPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AddonListAddonsResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AddonListAddonsResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<AddonListAddonsResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AddonListAddonsResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AddonListAddonsResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AddonListAddonsPageResponse].
         *
         ...
         */
        fun build(): AddonListAddonsPageResponse =
            AddonListAddonsPageResponse(
    ...
    fun validate(): AddonListAddonsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListAddonsPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AddonListAddonsPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
