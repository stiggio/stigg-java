...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AddonListAddonsParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AddonListAddonsParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AddonListAddonsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonListAddonsParams: AddonListAddonsParams) = apply {
            after = addonListAddonsParams.after
            before = addonListAddonsParams.before
            createdAt = addonListAddonsParams.createdAt
            limit = addonListAddonsParams.limit
            productId = addonListAddonsParams.productId
            status = addonListAddonsParams.status
            additionalHeaders = addonListAddonsParams.additionalHeaders.toBuilder()
            additionalQueryParams = addonListAddonsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AddonListAddonsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AddonListAddonsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListAddonsParams &&
            after == other.after &&
            before == other.before &&
    ...
    override fun toString() =
        "AddonListAddonsParams{after=$after, before=$before, createdAt=$createdAt, limit=$limit, productId=$productId, status=$status, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
