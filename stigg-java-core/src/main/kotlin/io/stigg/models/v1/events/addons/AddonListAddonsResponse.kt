...
private constructor(
     ...
     */
    @JsonProperty("maxQuantity") @ExcludeMissing fun _maxQuantity(): JsonField<Long> = maxQuantity
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonListAddonsResponse].
         *
    ...
    /** A builder for [AddonListAddonsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonListAddonsResponse: AddonListAddonsResponse) = apply {
            id = addonListAddonsResponse.id
            billingId = addonListAddonsResponse.billingId
            createdAt = addonListAddonsResponse.createdAt
            dependencies = addonListAddonsResponse.dependencies.map { it.toMutableList() }
            description = addonListAddonsResponse.description
            displayName = addonListAddonsResponse.displayName
            entitlements = addonListAddonsResponse.entitlements.map { it.toMutableList() }
            isLatest = addonListAddonsResponse.isLatest
            maxQuantity = addonListAddonsResponse.maxQuantity
            metadata = addonListAddonsResponse.metadata
            pricingType = addonListAddonsResponse.pricingType
            productId = addonListAddonsResponse.productId
            status = addonListAddonsResponse.status
            updatedAt = addonListAddonsResponse.updatedAt
            versionNumber = addonListAddonsResponse.versionNumber
            additionalProperties = addonListAddonsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonListAddonsResponse].
         *
         ...
         */
        fun build(): AddonListAddonsResponse =
    ...
    fun validate(): AddonListAddonsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonListAddonsResponse &&
            id == other.id &&
