...
class AddonPublishAddonResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonPublishAddonResponse].
         *
    ...
    /** A builder for [AddonPublishAddonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonPublishAddonResponse: AddonPublishAddonResponse) = apply {
            data = addonPublishAddonResponse.data
            additionalProperties = addonPublishAddonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonPublishAddonResponse].
         *
         ...
         */
        fun build(): AddonPublishAddonResponse =
    ...
    fun validate(): AddonPublishAddonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonPublishAddonResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonPublishAddonResponse{data=$data, additionalProperties=$additionalProperties}"
}
