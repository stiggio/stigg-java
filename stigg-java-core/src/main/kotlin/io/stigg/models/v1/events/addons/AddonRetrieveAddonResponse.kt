...
/** Response object */
class AddonRetrieveAddonResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonRetrieveAddonResponse].
         *
    ...
    /** A builder for [AddonRetrieveAddonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonRetrieveAddonResponse: AddonRetrieveAddonResponse) = apply {
            data = addonRetrieveAddonResponse.data
            additionalProperties = addonRetrieveAddonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonRetrieveAddonResponse].
         *
         ...
         */
        fun build(): AddonRetrieveAddonResponse =
    ...
    fun validate(): AddonRetrieveAddonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                dependencies = data.dependencies.map { it.toMutableList() }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonRetrieveAddonResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonRetrieveAddonResponse{data=$data, additionalProperties=$additionalProperties}"
}
