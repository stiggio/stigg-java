...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): AddonUpdateAddonParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [AddonUpdateAddonParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [AddonUpdateAddonParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonUpdateAddonParams: AddonUpdateAddonParams) = apply {
            id = addonUpdateAddonParams.id
            body = addonUpdateAddonParams.body.toBuilder()
            additionalHeaders = addonUpdateAddonParams.additionalHeaders.toBuilder()
            additionalQueryParams = addonUpdateAddonParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [AddonUpdateAddonParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): AddonUpdateAddonParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonUpdateAddonParams &&
            id == other.id &&
            body == other.body &&
    ...
    override fun toString() =
        "AddonUpdateAddonParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
