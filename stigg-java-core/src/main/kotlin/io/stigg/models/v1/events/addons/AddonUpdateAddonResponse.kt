...
/** Response object */
class AddonUpdateAddonResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonUpdateAddonResponse].
         *
    ...
    /** A builder for [AddonUpdateAddonResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonUpdateAddonResponse: AddonUpdateAddonResponse) = apply {
            data = addonUpdateAddonResponse.data
            additionalProperties = addonUpdateAddonResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonUpdateAddonResponse].
         *
         ...
         */
        fun build(): AddonUpdateAddonResponse =
    ...
    fun validate(): AddonUpdateAddonResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonUpdateAddonResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonUpdateAddonResponse{data=$data, additionalProperties=$additionalProperties}"
}
