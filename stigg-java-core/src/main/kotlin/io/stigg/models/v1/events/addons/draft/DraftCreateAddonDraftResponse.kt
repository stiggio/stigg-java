...
/** Response object */
class DraftCreateAddonDraftResponse
...
private constructor(
    ...
    /** A builder for [DraftCreateAddonDraftResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(draftCreateAddonDraftResponse: DraftCreateAddonDraftResponse) = apply {
            data = draftCreateAddonDraftResponse.data
            additionalProperties = draftCreateAddonDraftResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DraftCreateAddonDraftResponse].
         *
         ...
         */
        fun build(): DraftCreateAddonDraftResponse =
            DraftCreateAddonDraftResponse(
    ...
    fun validate(): DraftCreateAddonDraftResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DraftCreateAddonDraftResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "DraftCreateAddonDraftResponse{data=$data, additionalProperties=$additionalProperties}"
}
