...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AddonPackageEntitlement].
         *
    ...
    /** A builder for [AddonPackageEntitlement]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(addonPackageEntitlement: AddonPackageEntitlement) = apply {
            data = addonPackageEntitlement.data
            additionalProperties = addonPackageEntitlement.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [AddonPackageEntitlement].
         *
         ...
         */
        fun build(): AddonPackageEntitlement =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AddonPackageEntitlement &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "AddonPackageEntitlement{data=$data, additionalProperties=$additionalProperties}"
}
