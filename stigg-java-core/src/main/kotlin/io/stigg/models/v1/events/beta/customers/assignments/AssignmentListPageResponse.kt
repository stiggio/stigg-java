...
class AssignmentListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<AssignmentListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<AssignmentListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<AssignmentListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<AssignmentListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [AssignmentListPageResponse].
         *
    ...
    /** A builder for [AssignmentListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<AssignmentListResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(assignmentListPageResponse: AssignmentListPageResponse) = apply {
            data = assignmentListPageResponse.data.map { it.toMutableList() }
            pagination = assignmentListPageResponse.pagination
            additionalProperties = assignmentListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<AssignmentListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<AssignmentListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<AssignmentListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [AssignmentListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: AssignmentListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [AssignmentListPageResponse].
         *
         ...
         */
        fun build(): AssignmentListPageResponse =
     ...
     *   type.
     */
    fun validate(): AssignmentListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is AssignmentListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "AssignmentListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
