...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityArchiveParams: EntityArchiveParams) = apply {
            ...
            xAccountId = entityArchiveParams.xAccountId
            xEnvironmentId = entityArchiveParams.xEnvironmentId
            body = entityArchiveParams.body.toBuilder()
    ...
    override fun toString() =
        "EntityArchiveParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
