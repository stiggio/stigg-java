...
private constructor(
    private val data: JsonField<List<EntityListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EntityListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EntityListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<EntityListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<EntityListResponse>>? = null
        ...
        internal fun from(entityListPageResponse: EntityListPageResponse) = apply {
            ...
            pagination = entityListPageResponse.pagination
            additionalProperties = entityListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<EntityListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EntityListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<EntityListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EntityListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EntityListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "EntityListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
