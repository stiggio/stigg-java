...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entityListResponse: EntityListResponse) = apply {
            ...
            typeId = entityListResponse.typeId
         ...
         *
         * You should usually call [Builder.typeId] with a well-typed [String] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
    ...
    private val hashCode: Int by lazy {
        Objects.hash(id, archivedAt, createdAt, metadata, typeId, updatedAt, additionalProperties)
    }

    override fun hashCode(): Int = hashCode

    override fun toString() =
        "EntityListResponse{id=$id, archivedAt=$archivedAt, createdAt=$createdAt, metadata=$metadata, typeId=$typeId, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
