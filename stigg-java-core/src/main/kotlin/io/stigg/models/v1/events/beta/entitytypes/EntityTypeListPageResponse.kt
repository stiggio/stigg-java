...
class EntityTypeListPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<EntityTypeListResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<EntityTypeListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<EntityTypeListResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<EntityTypeListResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityTypeListPageResponse].
         *
    ...
    /** A builder for [EntityTypeListPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<EntityTypeListResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(entityTypeListPageResponse: EntityTypeListPageResponse) = apply {
            data = entityTypeListPageResponse.data.map { it.toMutableList() }
            pagination = entityTypeListPageResponse.pagination
            additionalProperties = entityTypeListPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<EntityTypeListResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<EntityTypeListResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<EntityTypeListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [EntityTypeListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: EntityTypeListResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [EntityTypeListPageResponse].
         *
         ...
         */
        fun build(): EntityTypeListPageResponse =
            EntityTypeListPageResponse(
     ...
     *   type.
     */
    fun validate(): EntityTypeListPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityTypeListPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "EntityTypeListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
