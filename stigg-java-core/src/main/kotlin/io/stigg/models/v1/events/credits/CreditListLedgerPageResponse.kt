...
private constructor(
    private val data: JsonField<List<CreditListLedgerResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<CreditListLedgerResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<CreditListLedgerResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<CreditListLedgerResponse>> = data
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditListLedgerPageResponse].
         *
    ...
    /** A builder for [CreditListLedgerPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<CreditListLedgerResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(creditListLedgerPageResponse: CreditListLedgerPageResponse) = apply {
            data = creditListLedgerPageResponse.data.map { it.toMutableList() }
            pagination = creditListLedgerPageResponse.pagination
            additionalProperties = creditListLedgerPageResponse.additionalProperties.toMutableMap()
        }

        fun data(data: List<CreditListLedgerResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed `List<CreditListLedgerResponse>`
         * value instead. This method is primarily for setting the field to an undocumented or not
         * yet supported value.
         */
        fun data(data: JsonField<List<CreditListLedgerResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [CreditListLedgerResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: CreditListLedgerResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [CreditListLedgerPageResponse].
         *
         ...
         */
        fun build(): CreditListLedgerPageResponse =
            CreditListLedgerPageResponse(
    ...
    fun validate(): CreditListLedgerPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditListLedgerPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "CreditListLedgerPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
