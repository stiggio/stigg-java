...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CreditListLedgerParams].
         *
    ...
    /** A builder for [CreditListLedgerParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(creditListLedgerParams: CreditListLedgerParams) = apply {
            customerId = creditListLedgerParams.customerId
        ...
        /**
         * Returns an immutable instance of [CreditListLedgerParams].
         *
         ...
         */
        fun build(): CreditListLedgerParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CreditListLedgerParams &&
