...
/** Response object */
class CustomCurrencyArchiveResponse
...
private constructor(
    ...
    /** A builder for [CustomCurrencyArchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyArchiveResponse: CustomCurrencyArchiveResponse) = apply {
            data = customCurrencyArchiveResponse.data
            additionalProperties = customCurrencyArchiveResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyArchiveResponse].
         *
         ...
         */
        fun build(): CustomCurrencyArchiveResponse =
            CustomCurrencyArchiveResponse(
     ...
     *   type.
     */
    fun validate(): CustomCurrencyArchiveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyArchiveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrencyArchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
