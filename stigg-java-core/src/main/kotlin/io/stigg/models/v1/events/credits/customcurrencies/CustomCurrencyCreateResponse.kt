...
/** Response object */
class CustomCurrencyCreateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomCurrencyCreateResponse].
         *
    ...
    /** A builder for [CustomCurrencyCreateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyCreateResponse: CustomCurrencyCreateResponse) = apply {
            data = customCurrencyCreateResponse.data
            additionalProperties = customCurrencyCreateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyCreateResponse].
         *
         ...
         */
        fun build(): CustomCurrencyCreateResponse =
     ...
     *   type.
     */
    fun validate(): CustomCurrencyCreateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyCreateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrencyCreateResponse{data=$data, additionalProperties=$additionalProperties}"
}
