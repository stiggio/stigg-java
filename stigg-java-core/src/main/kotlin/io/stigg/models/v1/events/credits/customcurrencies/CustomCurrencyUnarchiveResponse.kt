...
/** Response object */
class CustomCurrencyUnarchiveResponse
...
private constructor(
    ...
    /** A builder for [CustomCurrencyUnarchiveResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyUnarchiveResponse: CustomCurrencyUnarchiveResponse) =
            apply {
                data = customCurrencyUnarchiveResponse.data
                additionalProperties =
                    customCurrencyUnarchiveResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyUnarchiveResponse].
         *
         ...
         */
        fun build(): CustomCurrencyUnarchiveResponse =
            CustomCurrencyUnarchiveResponse(
     ...
     *   type.
     */
    fun validate(): CustomCurrencyUnarchiveResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyUnarchiveResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrencyUnarchiveResponse{data=$data, additionalProperties=$additionalProperties}"
}
