...
/** Response object */
class CustomCurrencyUpdateResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [CustomCurrencyUpdateResponse].
         *
    ...
    /** A builder for [CustomCurrencyUpdateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(customCurrencyUpdateResponse: CustomCurrencyUpdateResponse) = apply {
            data = customCurrencyUpdateResponse.data
            additionalProperties = customCurrencyUpdateResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [CustomCurrencyUpdateResponse].
         *
         ...
         */
        fun build(): CustomCurrencyUpdateResponse =
     ...
     *   type.
     */
    fun validate(): CustomCurrencyUpdateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is CustomCurrencyUpdateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "CustomCurrencyUpdateResponse{data=$data, additionalProperties=$additionalProperties}"
}
