 ...
 */
class DataExportListModelsParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataExportListModelsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [DataExportListModelsParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataExportListModelsParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataExportListModelsParams: DataExportListModelsParams) = apply {
            xAccountId = dataExportListModelsParams.xAccountId
            xEnvironmentId = dataExportListModelsParams.xEnvironmentId
            additionalHeaders = dataExportListModelsParams.additionalHeaders.toBuilder()
            additionalQueryParams = dataExportListModelsParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DataExportListModelsParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataExportListModelsParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DataExportListModelsParams &&
    ...
    override fun hashCode(): Int =
        Objects.hash(xAccountId, xEnvironmentId, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "DataExportListModelsParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
