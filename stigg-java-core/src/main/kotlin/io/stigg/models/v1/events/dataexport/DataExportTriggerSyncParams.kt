...
class DataExportTriggerSyncParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DataExportTriggerSyncParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [DataExportTriggerSyncParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DataExportTriggerSyncParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(dataExportTriggerSyncParams: DataExportTriggerSyncParams) = apply {
            xAccountId = dataExportTriggerSyncParams.xAccountId
            xEnvironmentId = dataExportTriggerSyncParams.xEnvironmentId
            body = dataExportTriggerSyncParams.body.toBuilder()
            additionalHeaders = dataExportTriggerSyncParams.additionalHeaders.toBuilder()
            additionalQueryParams = dataExportTriggerSyncParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [DataExportTriggerSyncParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): DataExportTriggerSyncParams =
    ...
    private constructor(
        ...
        ) : this(destinationId, mutableMapOf())
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(destinationId, additionalProperties.toMutableMap())
        }
         ...
         */
        @JvmSynthetic
        internal fun validity(): Int = (if (destinationId.asKnown().isPresent) 1 else 0)
        ...
        private val hashCode: Int by lazy { Objects.hash(destinationId, additionalProperties) }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{destinationId=$destinationId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is DataExportTriggerSyncParams &&
    ...
    override fun toString() =
        "DataExportTriggerSyncParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
