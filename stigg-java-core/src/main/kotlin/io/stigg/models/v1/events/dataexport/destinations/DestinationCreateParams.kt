...
private constructor(
    ...
    private constructor(
        ...
        ) : this(destinationId, destinationType, enabledModels, mutableMapOf())
        ...
        private val hashCode: Int by lazy {
            Objects.hash(destinationId, destinationType, enabledModels, additionalProperties)
        }

        override fun hashCode(): Int = hashCode

        override fun toString() =
            "Body{destinationId=$destinationId, destinationType=$destinationType, enabledModels=$enabledModels, additionalProperties=$additionalProperties}"
    }
