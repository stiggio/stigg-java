...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): DestinationDeleteParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [DestinationDeleteParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [DestinationDeleteParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(destinationDeleteParams: DestinationDeleteParams) = apply {
            ...
            additionalBodyProperties =
                destinationDeleteParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [DestinationDeleteParams].
         *
