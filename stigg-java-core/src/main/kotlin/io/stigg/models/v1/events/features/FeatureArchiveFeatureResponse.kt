...
/** Response object */
class FeatureArchiveFeatureResponse
...
private constructor(
    ...
    /** A builder for [FeatureArchiveFeatureResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureArchiveFeatureResponse: FeatureArchiveFeatureResponse) = apply {
            data = featureArchiveFeatureResponse.data
            additionalProperties = featureArchiveFeatureResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureArchiveFeatureResponse].
         *
         ...
         */
        fun build(): FeatureArchiveFeatureResponse =
            FeatureArchiveFeatureResponse(
    ...
    fun validate(): FeatureArchiveFeatureResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureArchiveFeatureResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FeatureArchiveFeatureResponse{data=$data, additionalProperties=$additionalProperties}"
}
