...
/** Response object */
class FeatureCreateFeatureResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureCreateFeatureResponse].
         *
    ...
    /** A builder for [FeatureCreateFeatureResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureCreateFeatureResponse: FeatureCreateFeatureResponse) = apply {
            data = featureCreateFeatureResponse.data
            additionalProperties = featureCreateFeatureResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureCreateFeatureResponse].
         *
         ...
         */
        fun build(): FeatureCreateFeatureResponse =
    ...
    fun validate(): FeatureCreateFeatureResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureCreateFeatureResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FeatureCreateFeatureResponse{data=$data, additionalProperties=$additionalProperties}"
}
