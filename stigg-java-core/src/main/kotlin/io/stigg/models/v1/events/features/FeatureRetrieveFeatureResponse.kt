...
/** Response object */
class FeatureRetrieveFeatureResponse
...
private constructor(
    ...
    /** A builder for [FeatureRetrieveFeatureResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureRetrieveFeatureResponse: FeatureRetrieveFeatureResponse) = apply {
            data = featureRetrieveFeatureResponse.data
            additionalProperties =
                featureRetrieveFeatureResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureRetrieveFeatureResponse].
         *
         ...
         */
        fun build(): FeatureRetrieveFeatureResponse =
            FeatureRetrieveFeatureResponse(
    ...
    fun validate(): FeatureRetrieveFeatureResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureRetrieveFeatureResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FeatureRetrieveFeatureResponse{data=$data, additionalProperties=$additionalProperties}"
}
