...
/** Response object */
class FeatureUnarchiveFeatureResponse
...
private constructor(
    ...
    /** A builder for [FeatureUnarchiveFeatureResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureUnarchiveFeatureResponse: FeatureUnarchiveFeatureResponse) =
            apply {
                data = featureUnarchiveFeatureResponse.data
                additionalProperties =
                    featureUnarchiveFeatureResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FeatureUnarchiveFeatureResponse].
         *
         ...
         */
        fun build(): FeatureUnarchiveFeatureResponse =
            FeatureUnarchiveFeatureResponse(
    ...
    fun validate(): FeatureUnarchiveFeatureResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureUnarchiveFeatureResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FeatureUnarchiveFeatureResponse{data=$data, additionalProperties=$additionalProperties}"
}
