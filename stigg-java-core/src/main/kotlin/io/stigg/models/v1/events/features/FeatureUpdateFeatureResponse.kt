...
/** Response object */
class FeatureUpdateFeatureResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureUpdateFeatureResponse].
         *
    ...
    /** A builder for [FeatureUpdateFeatureResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureUpdateFeatureResponse: FeatureUpdateFeatureResponse) = apply {
            data = featureUpdateFeatureResponse.data
            additionalProperties = featureUpdateFeatureResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureUpdateFeatureResponse].
         *
         ...
         */
        fun build(): FeatureUpdateFeatureResponse =
    ...
    fun validate(): FeatureUpdateFeatureResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureUpdateFeatureResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "FeatureUpdateFeatureResponse{data=$data, additionalProperties=$additionalProperties}"
}
