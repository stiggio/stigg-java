...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(featureCreateFeatureParams: FeatureCreateFeatureParams) = apply {
            xAccountId = featureCreateFeatureParams.xAccountId
            xEnvironmentId = featureCreateFeatureParams.xEnvironmentId
    ...
    override fun toString() =
        "FeatureCreateFeatureParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
