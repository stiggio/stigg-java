...
class FeatureListFeaturesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<FeatureListFeaturesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<FeatureListFeaturesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<FeatureListFeaturesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<FeatureListFeaturesResponse>> = data
    ...
    /** A builder for [FeatureListFeaturesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<FeatureListFeaturesResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(featureListFeaturesPageResponse: FeatureListFeaturesPageResponse) =
            apply {
                data = featureListFeaturesPageResponse.data.map { it.toMutableList() }
                pagination = featureListFeaturesPageResponse.pagination
                additionalProperties =
                    featureListFeaturesPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<FeatureListFeaturesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<FeatureListFeaturesResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<FeatureListFeaturesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [FeatureListFeaturesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: FeatureListFeaturesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [FeatureListFeaturesPageResponse].
         *
         ...
         */
        fun build(): FeatureListFeaturesPageResponse =
            FeatureListFeaturesPageResponse(
    ...
    fun validate(): FeatureListFeaturesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureListFeaturesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "FeatureListFeaturesPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
