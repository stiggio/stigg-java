...
class FeatureListFeaturesResponse
...
private constructor(
     ...
     */
    @JsonProperty("meterType") @ExcludeMissing fun _meterType(): JsonField<MeterType> = meterType
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [FeatureListFeaturesResponse].
         *
    ...
    /** A builder for [FeatureListFeaturesResponse]. */
    class Builder internal constructor() {
        ...
        private var meter: JsonField<Meter>? = null
        ...
        @JvmSynthetic
        internal fun from(featureListFeaturesResponse: FeatureListFeaturesResponse) = apply {
            id = featureListFeaturesResponse.id
            createdAt = featureListFeaturesResponse.createdAt
            description = featureListFeaturesResponse.description
            displayName = featureListFeaturesResponse.displayName
            enumConfiguration =
                featureListFeaturesResponse.enumConfiguration.map { it.toMutableList() }
            featureStatus = featureListFeaturesResponse.featureStatus
            featureType = featureListFeaturesResponse.featureType
            featureUnits = featureListFeaturesResponse.featureUnits
            featureUnitsPlural = featureListFeaturesResponse.featureUnitsPlural
            metadata = featureListFeaturesResponse.metadata
            meter = featureListFeaturesResponse.meter
            meterType = featureListFeaturesResponse.meterType
            unitTransformation = featureListFeaturesResponse.unitTransformation
            updatedAt = featureListFeaturesResponse.updatedAt
            additionalProperties = featureListFeaturesResponse.additionalProperties.toMutableMap()
        }
        ...
        /** The status of the feature */
        fun featureStatus(featureStatus: FeatureStatus) = featureStatus(JsonField.of(featureStatus))
        ...
        /** The units for the feature */
        fun featureUnits(featureUnits: String?) = featureUnits(JsonField.ofNullable(featureUnits))

        /** Alias for calling [Builder.featureUnits] with `featureUnits.orElse(null)`. */
        fun featureUnits(featureUnits: Optional<String>) = featureUnits(featureUnits.getOrNull())
        ...
        /**
         * Alias for calling [Builder.featureUnitsPlural] with `featureUnitsPlural.orElse(null)`.
         */
        ...
        /** Event meter that turns reported events into usage for a metered feature */
        fun meter(meter: Meter?) = meter(JsonField.ofNullable(meter))

        /** Alias for calling [Builder.meter] with `meter.orElse(null)`. */
        fun meter(meter: Optional<Meter>) = meter(meter.getOrNull())
        ...
        /**
         * Returns an immutable instance of [FeatureListFeaturesResponse].
         *
         ...
         */
        fun build(): FeatureListFeaturesResponse =
    ...
    private constructor(
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                ...
                /** Aggregation field name */
                fun field(field: String?) = field(JsonField.ofNullable(field))
        ...
        private constructor(
            ...
            private constructor(
                ...
                class Builder internal constructor() {
                    ...
                    fun values(values: List<String>?) = values(JsonField.ofNullable(values))

                    /** Alias for calling [Builder.values] with `values.orElse(null)`. */
                    fun values(values: Optional<List<String>>) = values(values.getOrNull())
    ...
    private constructor(
        ...
        @JsonCreator
        private constructor(
            @JsonProperty("divide") @ExcludeMissing divide: JsonField<Double> = JsonMissing.of(),
            @JsonProperty("featureUnits")
            @ExcludeMissing
            featureUnits: JsonField<String> = JsonMissing.of(),
            @JsonProperty("featureUnitsPlural")
        ...
        class Builder internal constructor() {
             ...
             *
             * You should usually call [Builder.divide] with a well-typed [Double] value instead.
             * This method is primarily for setting the field to an undocumented or not yet
             * supported value.
             */
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureListFeaturesResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "FeatureListFeaturesResponse{id=$id, createdAt=$createdAt, description=$description, displayName=$displayName, enumConfiguration=$enumConfiguration, featureStatus=$featureStatus, featureType=$featureType, featureUnits=$featureUnits, featureUnitsPlural=$featureUnitsPlural, metadata=$metadata, meter=$meter, meterType=$meterType, unitTransformation=$unitTransformation, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
}
