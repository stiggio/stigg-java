...
class FeatureRetrieveFeatureParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeatureRetrieveFeatureParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [FeatureRetrieveFeatureParams].
         */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [FeatureRetrieveFeatureParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureRetrieveFeatureParams: FeatureRetrieveFeatureParams) = apply {
            id = featureRetrieveFeatureParams.id
            xAccountId = featureRetrieveFeatureParams.xAccountId
            xEnvironmentId = featureRetrieveFeatureParams.xEnvironmentId
            additionalHeaders = featureRetrieveFeatureParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureRetrieveFeatureParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureRetrieveFeatureParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeatureRetrieveFeatureParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureRetrieveFeatureParams &&
            id == other.id &&
    ...
    override fun toString() =
        "FeatureRetrieveFeatureParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
