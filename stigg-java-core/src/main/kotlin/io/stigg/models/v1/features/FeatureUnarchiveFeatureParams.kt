...
class FeatureUnarchiveFeatureParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FeatureUnarchiveFeatureParams = builder().build()
    ...
    /** A builder for [FeatureUnarchiveFeatureParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(featureUnarchiveFeatureParams: FeatureUnarchiveFeatureParams) = apply {
            id = featureUnarchiveFeatureParams.id
            xAccountId = featureUnarchiveFeatureParams.xAccountId
            xEnvironmentId = featureUnarchiveFeatureParams.xEnvironmentId
            additionalHeaders = featureUnarchiveFeatureParams.additionalHeaders.toBuilder()
            additionalQueryParams = featureUnarchiveFeatureParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                featureUnarchiveFeatureParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FeatureUnarchiveFeatureParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FeatureUnarchiveFeatureParams =
            FeatureUnarchiveFeatureParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FeatureUnarchiveFeatureParams &&
            id == other.id &&
    ...
    override fun toString() =
        "FeatureUnarchiveFeatureParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
