...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PlanArchiveParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PlanArchiveParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlanArchiveParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planArchiveParams: PlanArchiveParams) = apply {
            id = planArchiveParams.id
            xAccountId = planArchiveParams.xAccountId
            xEnvironmentId = planArchiveParams.xEnvironmentId
            additionalHeaders = planArchiveParams.additionalHeaders.toBuilder()
            additionalQueryParams = planArchiveParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = planArchiveParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlanArchiveParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlanArchiveParams =
            PlanArchiveParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanArchiveParams &&
            id == other.id &&
    ...
    override fun toString() =
        "PlanArchiveParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
