...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PlanCreateDraftParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PlanCreateDraftParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlanCreateDraftParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planCreateDraftParams: PlanCreateDraftParams) = apply {
            id = planCreateDraftParams.id
            xAccountId = planCreateDraftParams.xAccountId
            xEnvironmentId = planCreateDraftParams.xEnvironmentId
            additionalHeaders = planCreateDraftParams.additionalHeaders.toBuilder()
            additionalQueryParams = planCreateDraftParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = planCreateDraftParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlanCreateDraftParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlanCreateDraftParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanCreateDraftParams &&
            id == other.id &&
    ...
    override fun toString() =
        "PlanCreateDraftParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
