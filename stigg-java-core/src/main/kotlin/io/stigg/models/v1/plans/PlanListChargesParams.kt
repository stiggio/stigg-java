...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): PlanListChargesParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [PlanListChargesParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [PlanListChargesParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(planListChargesParams: PlanListChargesParams) = apply {
            id = planListChargesParams.id
            after = planListChargesParams.after
            before = planListChargesParams.before
            limit = planListChargesParams.limit
            xAccountId = planListChargesParams.xAccountId
            xEnvironmentId = planListChargesParams.xEnvironmentId
        ...
        /**
         * Returns an immutable instance of [PlanListChargesParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): PlanListChargesParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanListChargesParams &&
            id == other.id &&
            after == other.after &&
            before == other.before &&
            limit == other.limit &&
    ...
    override fun toString() =
        "PlanListChargesParams{id=$id, after=$after, before=$before, limit=$limit, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
