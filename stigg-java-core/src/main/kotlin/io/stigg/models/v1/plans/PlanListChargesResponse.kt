...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planListChargesResponse: PlanListChargesResponse) = apply {
            ...
            billingCadence = planListChargesResponse.billingCadence
            billingModel = planListChargesResponse.billingModel
            billingPeriod = planListChargesResponse.billingPeriod
            createdAt = planListChargesResponse.createdAt
            billingCountryCode = planListChargesResponse.billingCountryCode
            billingId = planListChargesResponse.billingId
            blockSize = planListChargesResponse.blockSize
            creditGrantCadence = planListChargesResponse.creditGrantCadence
            creditRate = planListChargesResponse.creditRate
            crmId = planListChargesResponse.crmId
            crmLinkUrl = planListChargesResponse.crmLinkUrl
            featureId = planListChargesResponse.featureId
            maxUnitQuantity = planListChargesResponse.maxUnitQuantity
            minUnitQuantity = planListChargesResponse.minUnitQuantity
            price = planListChargesResponse.price
            tiers = planListChargesResponse.tiers.map { it.toMutableList() }
            tiersMode = planListChargesResponse.tiersMode
            topUpCustomCurrencyId = planListChargesResponse.topUpCustomCurrencyId
            usedInSubscriptions = planListChargesResponse.usedInSubscriptions
