...
class PlanListOverageChargesPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<PlanListOverageChargesResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PlanListOverageChargesResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PlanListOverageChargesResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<PlanListOverageChargesResponse>> = data
    ...
    /** A builder for [PlanListOverageChargesPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<PlanListOverageChargesResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(planListOverageChargesPageResponse: PlanListOverageChargesPageResponse) =
            apply {
                data = planListOverageChargesPageResponse.data.map { it.toMutableList() }
                pagination = planListOverageChargesPageResponse.pagination
                additionalProperties =
                    planListOverageChargesPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<PlanListOverageChargesResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<PlanListOverageChargesResponse>` value instead. This method is primarily for
         * setting the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<PlanListOverageChargesResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PlanListOverageChargesResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PlanListOverageChargesResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [PlanListOverageChargesPageResponse].
         *
         ...
         */
        fun build(): PlanListOverageChargesPageResponse =
            PlanListOverageChargesPageResponse(
     ...
     *   type.
     */
    fun validate(): PlanListOverageChargesPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanListOverageChargesPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "PlanListOverageChargesPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
