...
private constructor(
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<PlanListResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<PlanListResponse> = data.getRequired("data")
     ...
     */
    @JsonProperty("data") @ExcludeMissing fun _data(): JsonField<List<PlanListResponse>> = data
    ...
    class Builder internal constructor() {
        ...
        private var data: JsonField<MutableList<PlanListResponse>>? = null
        ...
        internal fun from(planListPageResponse: PlanListPageResponse) = apply {
            ...
            pagination = planListPageResponse.pagination
         ...
         *
         * You should usually call [Builder.data] with a well-typed `List<PlanListResponse>` value
         * instead. This method is primarily for setting the field to an undocumented or not yet
         * supported value.
         */
        fun data(data: JsonField<List<PlanListResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [PlanListResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: PlanListResponse) = apply {
            this.data =
    ...
    override fun toString() =
        "PlanListPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
