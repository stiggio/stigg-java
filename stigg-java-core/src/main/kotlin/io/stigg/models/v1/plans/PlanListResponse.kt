...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planListResponse: PlanListResponse) = apply {
            ...
            compatibleAddonIds = planListResponse.compatibleAddonIds.map { it.toMutableList() }
            createdAt = planListResponse.createdAt
            defaultTrialConfig = planListResponse.defaultTrialConfig
        ...
        fun build(): PlanListResponse =
            PlanListResponse(
                ...
                checkRequired("compatibleAddonIds", compatibleAddonIds).map { it.toImmutable() },
