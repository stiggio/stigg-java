...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [PlanPublishResponse].
         *
    ...
    /** A builder for [PlanPublishResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(planPublishResponse: PlanPublishResponse) = apply {
            data = planPublishResponse.data
            additionalProperties = planPublishResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [PlanPublishResponse].
         *
         ...
         */
        fun build(): PlanPublishResponse =
            PlanPublishResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): PlanPublishResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is PlanPublishResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "PlanPublishResponse{data=$data, additionalProperties=$additionalProperties}"
}
