...
private constructor(
     ...
     *
     * Unlike [compatibleAddonIds], this method doesn't throw if the JSON field has an unexpected
     * type.
     */
    fun _compatibleAddonIds(): JsonField<List<String>> = body._compatibleAddonIds()
    ...
    class Builder internal constructor() {
        ...
        fun compatibleAddonIds(compatibleAddonIds: List<String>?) = apply {
            body.compatibleAddonIds(compatibleAddonIds)
        }

        /**
         * Alias for calling [Builder.compatibleAddonIds] with `compatibleAddonIds.orElse(null)`.
         */
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(body: Body) = apply {
                ...
                compatibleAddonIds = body.compatibleAddonIds.map { it.toMutableList() }
            ...
            fun build(): Body =
                Body(
                    billingId,
                    (compatibleAddonIds ?: JsonMissing.of()).map { it.toImmutable() },
                    defaultTrialConfig,
                    description,
                    displayName,
                    metadata,
        ...
        override fun toString() =
            "Body{billingId=$billingId, compatibleAddonIds=$compatibleAddonIds, defaultTrialConfig=$defaultTrialConfig, description=$description, displayName=$displayName, metadata=$metadata, parentPlanId=$parentPlanId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "PlanUpdateParams{id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
