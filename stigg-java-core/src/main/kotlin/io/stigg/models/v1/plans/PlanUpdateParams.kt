...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(planUpdateParams: PlanUpdateParams) = apply {
            ...
            xAccountId = planUpdateParams.xAccountId
            xEnvironmentId = planUpdateParams.xEnvironmentId
    ...
    override fun toString() =
        "PlanUpdateParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
