...
private constructor(
     ...
     */
    fun credit(): Optional<Credit> = body.credit()
     ...
     *   server responded with an unexpected value).
     */
    fun feature(): Optional<Feature> = body.feature()
     ...
     */
    fun _credit(): JsonField<Credit> = body._credit()
     ...
     */
    fun _feature(): JsonField<Feature> = body._feature()
    ...
    class Builder internal constructor() {
        ...
        internal fun from(entitlementUpdateParams: EntitlementUpdateParams) = apply {
            planId = entitlementUpdateParams.planId
        ...
        /** Credit entitlement fields to update */
        fun credit(credit: Credit) = apply { body.credit(credit) }

        /**
         * Sets [Builder.credit] to an arbitrary JSON value.
         *
         * You should usually call [Builder.credit] with a well-typed [Credit] value instead. This
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun credit(credit: JsonField<Credit>) = apply { body.credit(credit) }

        /** Feature entitlement fields to update */
        fun feature(feature: Feature) = apply { body.feature(feature) }
         ...
         * method is primarily for setting the field to an undocumented or not yet supported value.
         */
        fun feature(feature: JsonField<Feature>) = apply { body.feature(feature) }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
             ...
             * Further updates to this [Builder] will not mutate the returned instance.
             */
            fun build(): Body = Body(credit, feature, additionalProperties.toMutableMap())
        }
        ...
        override fun toString() =
            "Body{credit=$credit, feature=$feature, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        override fun toString() =
            "Credit{amount=$amount, behavior=$behavior, cadence=$cadence, description=$description, displayNameOverride=$displayNameOverride, hiddenFromWidgets=$hiddenFromWidgets, isCustom=$isCustom, isGranted=$isGranted, order=$order, additionalProperties=$additionalProperties}"
    }
    ...
    private constructor(
        ...
        override fun toString() =
            "Feature{behavior=$behavior, description=$description, displayNameOverride=$displayNameOverride, enumValues=$enumValues, hasSoftLimit=$hasSoftLimit, hasUnlimitedUsage=$hasUnlimitedUsage, hiddenFromWidgets=$hiddenFromWidgets, isCustom=$isCustom, isGranted=$isGranted, monthlyResetPeriodConfiguration=$monthlyResetPeriodConfiguration, order=$order, resetPeriod=$resetPeriod, usageLimit=$usageLimit, weeklyResetPeriodConfiguration=$weeklyResetPeriodConfiguration, yearlyResetPeriodConfiguration=$yearlyResetPeriodConfiguration, additionalProperties=$additionalProperties}"
    }
    ...
    override fun hashCode(): Int =
        Objects.hash(planId, id, body, additionalHeaders, additionalQueryParams)

    override fun toString() =
        "EntitlementUpdateParams{planId=$planId, id=$id, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
