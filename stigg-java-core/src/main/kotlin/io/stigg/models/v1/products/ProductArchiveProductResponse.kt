...
/** Response object */
class ProductArchiveProductResponse
...
private constructor(
    ...
    /** A builder for [ProductArchiveProductResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productArchiveProductResponse: ProductArchiveProductResponse) = apply {
            data = productArchiveProductResponse.data
            additionalProperties = productArchiveProductResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductArchiveProductResponse].
         *
         ...
         */
        fun build(): ProductArchiveProductResponse =
            ProductArchiveProductResponse(
    ...
    fun validate(): ProductArchiveProductResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductArchiveProductResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProductArchiveProductResponse{data=$data, additionalProperties=$additionalProperties}"
}
