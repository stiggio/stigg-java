...
class ProductCreateProductParams
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductCreateProductParams].
         *
    ...
    /** A builder for [ProductCreateProductParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productCreateProductParams: ProductCreateProductParams) = apply {
            xAccountId = productCreateProductParams.xAccountId
            xEnvironmentId = productCreateProductParams.xEnvironmentId
            body = productCreateProductParams.body.toBuilder()
            additionalHeaders = productCreateProductParams.additionalHeaders.toBuilder()
            additionalQueryParams = productCreateProductParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [ProductCreateProductParams].
         *
         ...
         */
        fun build(): ProductCreateProductParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductCreateProductParams &&
    ...
    override fun toString() =
        "ProductCreateProductParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
