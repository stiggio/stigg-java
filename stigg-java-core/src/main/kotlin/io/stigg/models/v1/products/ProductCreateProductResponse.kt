...
/** Response object */
class ProductCreateProductResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductCreateProductResponse].
         *
    ...
    /** A builder for [ProductCreateProductResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productCreateProductResponse: ProductCreateProductResponse) = apply {
            data = productCreateProductResponse.data
            additionalProperties = productCreateProductResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductCreateProductResponse].
         *
         ...
         */
        fun build(): ProductCreateProductResponse =
    ...
    fun validate(): ProductCreateProductResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductCreateProductResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProductCreateProductResponse{data=$data, additionalProperties=$additionalProperties}"
}
