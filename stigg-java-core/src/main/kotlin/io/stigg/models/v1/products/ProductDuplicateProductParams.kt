...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productDuplicateProductParams: ProductDuplicateProductParams) = apply {
            ...
            xAccountId = productDuplicateProductParams.xAccountId
            xEnvironmentId = productDuplicateProductParams.xEnvironmentId
    ...
    override fun toString() =
        "ProductDuplicateProductParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
