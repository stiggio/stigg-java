...
class ProductListProductsPageResponse
@JsonCreator(mode = JsonCreator.Mode.DISABLED)
private constructor(
    private val data: JsonField<List<ProductListProductsResponse>>,
    ...
    private constructor(
        @JsonProperty("data")
        @ExcludeMissing
        data: JsonField<List<ProductListProductsResponse>> = JsonMissing.of(),
     ...
     */
    fun data(): List<ProductListProductsResponse> = data.getRequired("data")
    ...
    @JsonProperty("data")
    @ExcludeMissing
    fun _data(): JsonField<List<ProductListProductsResponse>> = data
    ...
    /** A builder for [ProductListProductsPageResponse]. */
    class Builder internal constructor() {

        private var data: JsonField<MutableList<ProductListProductsResponse>>? = null
        private var pagination: JsonField<Pagination>? = null
        private var additionalProperties: MutableMap<String, JsonValue> = mutableMapOf()

        @JvmSynthetic
        internal fun from(productListProductsPageResponse: ProductListProductsPageResponse) =
            apply {
                data = productListProductsPageResponse.data.map { it.toMutableList() }
                pagination = productListProductsPageResponse.pagination
                additionalProperties =
                    productListProductsPageResponse.additionalProperties.toMutableMap()
            }

        fun data(data: List<ProductListProductsResponse>) = data(JsonField.of(data))

        /**
         * Sets [Builder.data] to an arbitrary JSON value.
         *
         * You should usually call [Builder.data] with a well-typed
         * `List<ProductListProductsResponse>` value instead. This method is primarily for setting
         * the field to an undocumented or not yet supported value.
         */
        fun data(data: JsonField<List<ProductListProductsResponse>>) = apply {
            this.data = data.map { it.toMutableList() }
        }

        /**
         * Adds a single [ProductListProductsResponse] to [Builder.data].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addData(data: ProductListProductsResponse) = apply {
            this.data =
        ...
        /**
         * Returns an immutable instance of [ProductListProductsPageResponse].
         *
         ...
         */
        fun build(): ProductListProductsPageResponse =
            ProductListProductsPageResponse(
     ...
     *   type.
     */
    fun validate(): ProductListProductsPageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductListProductsPageResponse &&
            data == other.data &&
    ...
    override fun toString() =
        "ProductListProductsPageResponse{data=$data, pagination=$pagination, additionalProperties=$additionalProperties}"
}
