...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ProductListProductsParams = builder().build()

        /**
         * Returns a mutable builder for constructing an instance of [ProductListProductsParams].
         */
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productListProductsParams: ProductListProductsParams) = apply {
            ...
            status = productListProductsParams.status?.toMutableList()
            xAccountId = productListProductsParams.xAccountId
            xEnvironmentId = productListProductsParams.xEnvironmentId
        ...
        /**
         * Returns an immutable instance of [ProductListProductsParams].
         *
    ...
    override fun toString() =
        "ProductListProductsParams{id=$id, after=$after, before=$before, createdAt=$createdAt, limit=$limit, status=$status, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
