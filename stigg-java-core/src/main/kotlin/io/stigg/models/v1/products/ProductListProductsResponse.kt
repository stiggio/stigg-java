...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductListProductsResponse].
         *
    ...
    /** A builder for [ProductListProductsResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productListProductsResponse: ProductListProductsResponse) = apply {
            id = productListProductsResponse.id
            createdAt = productListProductsResponse.createdAt
            description = productListProductsResponse.description
            displayName = productListProductsResponse.displayName
            metadata = productListProductsResponse.metadata
            multipleSubscriptions = productListProductsResponse.multipleSubscriptions
            status = productListProductsResponse.status
            updatedAt = productListProductsResponse.updatedAt
            productSettings = productListProductsResponse.productSettings
            additionalProperties = productListProductsResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductListProductsResponse].
         *
         ...
         */
        fun build(): ProductListProductsResponse =
     ...
     *   type.
     */
    fun validate(): ProductListProductsResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductListProductsResponse &&
            id == other.id &&
    ...
    override fun toString() =
        "ProductListProductsResponse{id=$id, createdAt=$createdAt, description=$description, displayName=$displayName, metadata=$metadata, multipleSubscriptions=$multipleSubscriptions, status=$status, updatedAt=$updatedAt, productSettings=$productSettings, additionalProperties=$additionalProperties}"
}
