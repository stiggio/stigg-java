...
class ProductUnarchiveProductParams
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): ProductUnarchiveProductParams = builder().build()
    ...
    /** A builder for [ProductUnarchiveProductParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUnarchiveProductParams: ProductUnarchiveProductParams) = apply {
            id = productUnarchiveProductParams.id
            xAccountId = productUnarchiveProductParams.xAccountId
            xEnvironmentId = productUnarchiveProductParams.xEnvironmentId
            additionalHeaders = productUnarchiveProductParams.additionalHeaders.toBuilder()
            additionalQueryParams = productUnarchiveProductParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                productUnarchiveProductParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductUnarchiveProductParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): ProductUnarchiveProductParams =
            ProductUnarchiveProductParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductUnarchiveProductParams &&
            id == other.id &&
    ...
    override fun toString() =
        "ProductUnarchiveProductParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
