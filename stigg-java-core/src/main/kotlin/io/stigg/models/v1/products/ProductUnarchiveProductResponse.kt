...
/** Response object */
class ProductUnarchiveProductResponse
...
private constructor(
    ...
    /** A builder for [ProductUnarchiveProductResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUnarchiveProductResponse: ProductUnarchiveProductResponse) =
            apply {
                data = productUnarchiveProductResponse.data
                additionalProperties =
                    productUnarchiveProductResponse.additionalProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [ProductUnarchiveProductResponse].
         *
         ...
         */
        fun build(): ProductUnarchiveProductResponse =
            ProductUnarchiveProductResponse(
    ...
    fun validate(): ProductUnarchiveProductResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductUnarchiveProductResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProductUnarchiveProductResponse{data=$data, additionalProperties=$additionalProperties}"
}
