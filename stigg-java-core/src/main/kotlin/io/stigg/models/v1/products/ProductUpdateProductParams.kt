...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(productUpdateProductParams: ProductUpdateProductParams) = apply {
            ...
            xAccountId = productUpdateProductParams.xAccountId
            xEnvironmentId = productUpdateProductParams.xEnvironmentId
    ...
    override fun toString() =
        "ProductUpdateProductParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
