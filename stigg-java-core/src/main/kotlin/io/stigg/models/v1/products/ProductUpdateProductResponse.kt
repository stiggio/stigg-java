...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [ProductUpdateProductResponse].
         *
    ...
    /** A builder for [ProductUpdateProductResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(productUpdateProductResponse: ProductUpdateProductResponse) = apply {
            data = productUpdateProductResponse.data
            additionalProperties = productUpdateProductResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [ProductUpdateProductResponse].
         *
         ...
         */
        fun build(): ProductUpdateProductResponse =
    ...
    fun validate(): ProductUpdateProductResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is ProductUpdateProductResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "ProductUpdateProductResponse{data=$data, additionalProperties=$additionalProperties}"
}
