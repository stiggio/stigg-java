...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        fun build(): Subscription =
            Subscription(checkRequired("data", data), additionalProperties.toMutableMap())
    }
    ...
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                ...
                subscriptionEntitlements = data.subscriptionEntitlements.map { it.toMutableList() }
                trial = data.trial
             ...
             * `List<FutureUpdate>` value instead. This method is primarily for setting the field to
             * an undocumented or not yet supported value.
             */
        ...
        private constructor(
            ...
            class Builder internal constructor() {
                 ...
                 * [ScheduleStatus] value instead. This method is primarily for setting the field to
                 * an undocumented or not yet supported value.
                 */
                 ...
                 * [SubscriptionScheduleType] value instead. This method is primarily for setting
                 * the field to an undocumented or not yet supported value.
                 */
            ...
            private constructor(private val value: JsonField<String>) : Enum {
                ...
                enum class Value {
                    ...
                    BILLING_INFO_METADATA,
                    /**
                     * An enum member indicating that [SubscriptionScheduleType] was instantiated
        ...
        private constructor(
             ...
             *
             * Unlike [baseCharge], this method doesn't throw if the JSON field has an unexpected
             * type.
             */
            @JsonProperty("baseCharge")
            @ExcludeMissing
    ...
    override fun toString() = "Subscription{data=$data, additionalProperties=$additionalProperties}"
}
