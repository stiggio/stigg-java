...
/** Response object */
class SubscriptionImportResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionImportResponse].
         *
    ...
    /** A builder for [SubscriptionImportResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionImportResponse: SubscriptionImportResponse) = apply {
            data = subscriptionImportResponse.data
            additionalProperties = subscriptionImportResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionImportResponse].
         *
         ...
         */
        fun build(): SubscriptionImportResponse =
    ...
    fun validate(): SubscriptionImportResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionImportResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SubscriptionImportResponse{data=$data, additionalProperties=$additionalProperties}"
}
