...
private constructor(
    ...
    fun pricingType(): Optional<List<PricingType>> = Optional.ofNullable(pricingType)
    ...
    class Builder internal constructor() {
        ...
        /** Filter by pricing type. Supports comma-separated values for multiple types */
        fun pricingType(pricingType: List<PricingType>?) = apply {
            this.pricingType = pricingType?.toMutableList()
        }

        /** Alias for calling [Builder.pricingType] with `pricingType.orElse(null)`. */
        fun pricingType(pricingType: Optional<List<PricingType>>) =
            pricingType(pricingType.getOrNull())

        /**
         * Adds a single [PricingType] to [Builder.pricingType].
         *
         * @throws IllegalStateException if the field was previously set to a non-list.
         */
        fun addPricingType(pricingType: PricingType) = apply {
            this.pricingType = (this.pricingType ?: mutableListOf()).apply { add(pricingType) }
        }
    ...
    override fun _queryParams(): QueryParams =
        QueryParams.builder()
            .apply {
                ...
                pricingType?.let { put("pricingType", it.joinToString(",") { it.toString() }) }
