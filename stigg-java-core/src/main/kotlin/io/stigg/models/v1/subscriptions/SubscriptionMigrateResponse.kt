...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionMigrateResponse].
         *
    ...
    /** A builder for [SubscriptionMigrateResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionMigrateResponse: SubscriptionMigrateResponse) = apply {
        ...
        /**
         * Returns an immutable instance of [SubscriptionMigrateResponse].
         *
         ...
         */
        fun build(): SubscriptionMigrateResponse =
    ...
    fun validate(): SubscriptionMigrateResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionMigrateResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SubscriptionMigrateResponse{data=$data, additionalProperties=$additionalProperties}"
}
