...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [SubscriptionTransferResponse].
         *
    ...
    /** A builder for [SubscriptionTransferResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(subscriptionTransferResponse: SubscriptionTransferResponse) = apply {
            data = subscriptionTransferResponse.data
            additionalProperties = subscriptionTransferResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [SubscriptionTransferResponse].
         *
         ...
         */
        fun build(): SubscriptionTransferResponse =
    ...
    fun validate(): SubscriptionTransferResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is SubscriptionTransferResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "SubscriptionTransferResponse{data=$data, additionalProperties=$additionalProperties}"
}
