...
private constructor(
    ...
    class Builder internal constructor() {
        ...
        internal fun from(subscriptionUpdateParams: SubscriptionUpdateParams) = apply {
            ...
            xAccountId = subscriptionUpdateParams.xAccountId
            xEnvironmentId = subscriptionUpdateParams.xEnvironmentId
    ...
    private constructor(
        ...
        ) : this(addonId, amount, baseCharge, currency, currencyId, featureId, mutableMapOf())
        ...
        override fun toString() =
            "PriceOverride{addonId=$addonId, amount=$amount, baseCharge=$baseCharge, currency=$currency, currencyId=$currencyId, featureId=$featureId, additionalProperties=$additionalProperties}"
    }
    ...
    override fun toString() =
        "SubscriptionUpdateParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
