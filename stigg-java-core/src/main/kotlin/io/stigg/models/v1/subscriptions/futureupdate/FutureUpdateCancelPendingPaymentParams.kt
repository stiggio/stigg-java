...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FutureUpdateCancelPendingPaymentParams = builder().build()
    ...
    /** A builder for [FutureUpdateCancelPendingPaymentParams]. */
    class Builder internal constructor() {
        ...
        internal fun from(
            ...
            id = futureUpdateCancelPendingPaymentParams.id
            xAccountId = futureUpdateCancelPendingPaymentParams.xAccountId
            xEnvironmentId = futureUpdateCancelPendingPaymentParams.xEnvironmentId
            additionalHeaders = futureUpdateCancelPendingPaymentParams.additionalHeaders.toBuilder()
            additionalQueryParams =
                futureUpdateCancelPendingPaymentParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                futureUpdateCancelPendingPaymentParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [FutureUpdateCancelPendingPaymentParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FutureUpdateCancelPendingPaymentParams =
            FutureUpdateCancelPendingPaymentParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FutureUpdateCancelPendingPaymentParams &&
            id == other.id &&
    ...
    override fun toString() =
        "FutureUpdateCancelPendingPaymentParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
