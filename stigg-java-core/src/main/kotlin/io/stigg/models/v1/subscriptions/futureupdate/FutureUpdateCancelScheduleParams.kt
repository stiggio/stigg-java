...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): FutureUpdateCancelScheduleParams = builder().build()
    ...
    /** A builder for [FutureUpdateCancelScheduleParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(futureUpdateCancelScheduleParams: FutureUpdateCancelScheduleParams) =
            apply {
                id = futureUpdateCancelScheduleParams.id
                xAccountId = futureUpdateCancelScheduleParams.xAccountId
                xEnvironmentId = futureUpdateCancelScheduleParams.xEnvironmentId
                additionalHeaders = futureUpdateCancelScheduleParams.additionalHeaders.toBuilder()
                additionalQueryParams =
                    futureUpdateCancelScheduleParams.additionalQueryParams.toBuilder()
                additionalBodyProperties =
                    futureUpdateCancelScheduleParams.additionalBodyProperties.toMutableMap()
            }
        ...
        /**
         * Returns an immutable instance of [FutureUpdateCancelScheduleParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): FutureUpdateCancelScheduleParams =
            FutureUpdateCancelScheduleParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is FutureUpdateCancelScheduleParams &&
            id == other.id &&
    ...
    override fun toString() =
        "FutureUpdateCancelScheduleParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
