...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): InvoiceMarkAsPaidParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [InvoiceMarkAsPaidParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [InvoiceMarkAsPaidParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(invoiceMarkAsPaidParams: InvoiceMarkAsPaidParams) = apply {
            id = invoiceMarkAsPaidParams.id
            xAccountId = invoiceMarkAsPaidParams.xAccountId
            xEnvironmentId = invoiceMarkAsPaidParams.xEnvironmentId
            additionalHeaders = invoiceMarkAsPaidParams.additionalHeaders.toBuilder()
            additionalQueryParams = invoiceMarkAsPaidParams.additionalQueryParams.toBuilder()
            additionalBodyProperties =
                invoiceMarkAsPaidParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [InvoiceMarkAsPaidParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): InvoiceMarkAsPaidParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is InvoiceMarkAsPaidParams &&
            id == other.id &&
    ...
    override fun toString() =
        "InvoiceMarkAsPaidParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
