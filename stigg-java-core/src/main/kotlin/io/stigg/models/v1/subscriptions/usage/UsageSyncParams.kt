...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): UsageSyncParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [UsageSyncParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [UsageSyncParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageSyncParams: UsageSyncParams) = apply {
            id = usageSyncParams.id
            xAccountId = usageSyncParams.xAccountId
            xEnvironmentId = usageSyncParams.xEnvironmentId
            additionalHeaders = usageSyncParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageSyncParams.additionalQueryParams.toBuilder()
            additionalBodyProperties = usageSyncParams.additionalBodyProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageSyncParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): UsageSyncParams =
            UsageSyncParams(
                id,
                xAccountId,
                xEnvironmentId,
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageSyncParams &&
            id == other.id &&
    ...
    override fun toString() =
        "UsageSyncParams{id=$id, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams, additionalBodyProperties=$additionalBodyProperties}"
}
