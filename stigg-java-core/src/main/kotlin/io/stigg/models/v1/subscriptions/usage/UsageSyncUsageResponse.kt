...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageSyncUsageResponse].
         *
    ...
    /** A builder for [UsageSyncUsageResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageSyncUsageResponse: UsageSyncUsageResponse) = apply {
            data = usageSyncUsageResponse.data
            additionalProperties = usageSyncUsageResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageSyncUsageResponse].
         *
         ...
         */
        fun build(): UsageSyncUsageResponse =
            UsageSyncUsageResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): UsageSyncUsageResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageSyncUsageResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "UsageSyncUsageResponse{data=$data, additionalProperties=$additionalProperties}"
}
