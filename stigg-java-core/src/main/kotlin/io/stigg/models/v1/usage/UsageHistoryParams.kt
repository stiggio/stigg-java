...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageHistoryParams].
         *
    ...
    /** A builder for [UsageHistoryParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageHistoryParams: UsageHistoryParams) = apply {
            customerId = usageHistoryParams.customerId
            featureId = usageHistoryParams.featureId
        ...
        /**
         * Returns an immutable instance of [UsageHistoryParams].
         *
