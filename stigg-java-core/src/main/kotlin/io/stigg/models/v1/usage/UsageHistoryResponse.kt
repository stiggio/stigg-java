...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageHistoryResponse].
         *
    ...
    /** A builder for [UsageHistoryResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageHistoryResponse: UsageHistoryResponse) = apply {
            data = usageHistoryResponse.data
            additionalProperties = usageHistoryResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [UsageHistoryResponse].
         *
         ...
         */
        fun build(): UsageHistoryResponse =
            UsageHistoryResponse(checkRequired("data", data), additionalProperties.toMutableMap())
    }

    private var validated: Boolean = false

    fun validate(): UsageHistoryResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageHistoryResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "UsageHistoryResponse{data=$data, additionalProperties=$additionalProperties}"
}
