...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [UsageReportParams].
         *
    ...
    /** A builder for [UsageReportParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(usageReportParams: UsageReportParams) = apply {
            xAccountId = usageReportParams.xAccountId
            xEnvironmentId = usageReportParams.xEnvironmentId
            body = usageReportParams.body.toBuilder()
            additionalHeaders = usageReportParams.additionalHeaders.toBuilder()
            additionalQueryParams = usageReportParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [UsageReportParams].
         *
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is UsageReportParams &&
    ...
    override fun toString() =
        "UsageReportParams{xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, body=$body, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
