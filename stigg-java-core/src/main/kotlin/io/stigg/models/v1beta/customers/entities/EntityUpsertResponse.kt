...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityUpsertResponse].
         *
    ...
    /** A builder for [EntityUpsertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityUpsertResponse: EntityUpsertResponse) = apply {
            data = entityUpsertResponse.data.map { it.toMutableList() }
            additionalProperties = entityUpsertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntityUpsertResponse].
         *
         ...
         */
        fun build(): EntityUpsertResponse =
     ...
     *   type.
     */
    fun validate(): EntityUpsertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    private constructor(
        ...
        override fun toString() =
            "Data{id=$id, archivedAt=$archivedAt, createdAt=$createdAt, displayName=$displayName, entityTypeId=$entityTypeId, metadata=$metadata, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityUpsertResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EntityUpsertResponse{data=$data, additionalProperties=$additionalProperties}"
}
