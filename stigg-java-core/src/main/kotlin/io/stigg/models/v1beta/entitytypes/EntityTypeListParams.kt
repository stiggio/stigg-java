...
private constructor(
    ...
    companion object {
        ...
        @JvmStatic fun none(): EntityTypeListParams = builder().build()

        /** Returns a mutable builder for constructing an instance of [EntityTypeListParams]. */
        @JvmStatic fun builder() = Builder()
    }

    /** A builder for [EntityTypeListParams]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityTypeListParams: EntityTypeListParams) = apply {
            after = entityTypeListParams.after
            before = entityTypeListParams.before
            limit = entityTypeListParams.limit
            xAccountId = entityTypeListParams.xAccountId
            xEnvironmentId = entityTypeListParams.xEnvironmentId
            additionalHeaders = entityTypeListParams.additionalHeaders.toBuilder()
            additionalQueryParams = entityTypeListParams.additionalQueryParams.toBuilder()
        }
        ...
        /**
         * Returns an immutable instance of [EntityTypeListParams].
         *
         * Further updates to this [Builder] will not mutate the returned instance.
         */
        fun build(): EntityTypeListParams =
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityTypeListParams &&
            after == other.after &&
            before == other.before &&
            limit == other.limit &&
    ...
    override fun toString() =
        "EntityTypeListParams{after=$after, before=$before, limit=$limit, xAccountId=$xAccountId, xEnvironmentId=$xEnvironmentId, additionalHeaders=$additionalHeaders, additionalQueryParams=$additionalQueryParams}"
}
