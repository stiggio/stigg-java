...
/**
 * A vendor-defined category of resource that can be governed (e.g. Org, Team, User). Vendors define
 * entity types once per environment; their customers create instances (entities) of these types and
 * the governance engine tracks usage and enforces limits per instance.
 */
class EntityTypeListResponse
...
private constructor(
     ...
     *
     * Unlike [attributionKeys], this method doesn't throw if the JSON field has an unexpected type.
     */
    @JsonProperty("attributionKeys")
    @ExcludeMissing
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityTypeListResponse].
         *
    ...
    /** A builder for [EntityTypeListResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityTypeListResponse: EntityTypeListResponse) = apply {
         ...
         *
         * You should usually call [Builder.attributionKeys] with a well-typed `List<String>` value
        ...
        /**
         * Returns an immutable instance of [EntityTypeListResponse].
         *
         ...
         */
        fun build(): EntityTypeListResponse =
     ...
     *   type.
     */
    fun validate(): EntityTypeListResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityTypeListResponse &&
            id == other.id &&
