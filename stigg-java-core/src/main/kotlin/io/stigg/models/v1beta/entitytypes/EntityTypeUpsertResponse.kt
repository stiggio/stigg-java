...
class EntityTypeUpsertResponse
...
private constructor(
    ...
    companion object {
        ...
        /**
         * Returns a mutable builder for constructing an instance of [EntityTypeUpsertResponse].
         *
    ...
    /** A builder for [EntityTypeUpsertResponse]. */
    class Builder internal constructor() {
        ...
        @JvmSynthetic
        internal fun from(entityTypeUpsertResponse: EntityTypeUpsertResponse) = apply {
            data = entityTypeUpsertResponse.data.map { it.toMutableList() }
            additionalProperties = entityTypeUpsertResponse.additionalProperties.toMutableMap()
        }
        ...
        /**
         * Returns an immutable instance of [EntityTypeUpsertResponse].
         *
         ...
         */
        fun build(): EntityTypeUpsertResponse =
     ...
     *   type.
     */
    fun validate(): EntityTypeUpsertResponse = apply {
        if (validated) {
            return@apply
        }
    ...
    /**
     * A vendor-defined category of resource that can be governed (e.g. Org, Team, User). Vendors
     * define entity types once per environment; their customers create instances (entities) of
     * these types and the governance engine tracks usage and enforces limits per instance.
     */
    class Data
    @JsonCreator(mode = JsonCreator.Mode.DISABLED)
    private constructor(
        ...
        class Builder internal constructor() {
            ...
            internal fun from(data: Data) = apply {
                id = data.id
                attributionKeys = data.attributionKeys.map { it.toMutableList() }
            ...
            /**
             * What this entity type represents and what it is for governing, or null when none is
             * set
             */
        ...
        override fun toString() =
            "Data{id=$id, attributionKeys=$attributionKeys, createdAt=$createdAt, description=$description, displayName=$displayName, updatedAt=$updatedAt, additionalProperties=$additionalProperties}"
    }
    ...
    override fun equals(other: Any?): Boolean {
        ...
        return other is EntityTypeUpsertResponse &&
            data == other.data &&
            additionalProperties == other.additionalProperties
    }
    ...
    override fun toString() =
        "EntityTypeUpsertResponse{data=$data, additionalProperties=$additionalProperties}"
}
