...
import io.stigg.services.async.v1.credits.AutoRechargeServiceAsyncImpl
...
class CreditServiceAsyncImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val autoRecharge: AutoRechargeServiceAsync by lazy {
        AutoRechargeServiceAsyncImpl(clientOptions)
    }
    ...
    override fun autoRecharge(): AutoRechargeServiceAsync = autoRecharge
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val autoRecharge: AutoRechargeServiceAsync.WithRawResponse by lazy {
            AutoRechargeServiceAsyncImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        override fun autoRecharge(): AutoRechargeServiceAsync.WithRawResponse = autoRecharge
