...
interface CustomCurrencyServiceAsync {
    ...
    fun create(params: CustomCurrencyCreateParams): CompletableFuture<CustomCurrency> =
    ...
    ): CompletableFuture<CustomCurrency>

    /** Updates an existing custom currency. Only the supplied fields are modified. */
    fun update(currencyId: String): CompletableFuture<CustomCurrency> =
    ...
    fun update(
        currencyId: String,
        params: CustomCurrencyUpdateParams = CustomCurrencyUpdateParams.none(),
    ): CompletableFuture<CustomCurrency> = update(currencyId, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: CustomCurrencyUpdateParams): CompletableFuture<CustomCurrency> =
     ...
     */
    fun archive(currencyId: String): CompletableFuture<CustomCurrency> =
    ...
    fun archive(
        currencyId: String,
        params: CustomCurrencyArchiveParams = CustomCurrencyArchiveParams.none(),
    ): CompletableFuture<CustomCurrency> = archive(currencyId, params, RequestOptions.none())
    ...
    /** @see archive */
    fun archive(params: CustomCurrencyArchiveParams): CompletableFuture<CustomCurrency> =
     ...
     */
    fun unarchive(currencyId: String): CompletableFuture<CustomCurrency> =
    ...
    fun unarchive(
        currencyId: String,
        params: CustomCurrencyUnarchiveParams = CustomCurrencyUnarchiveParams.none(),
    ): CompletableFuture<CustomCurrency> = unarchive(currencyId, params, RequestOptions.none())
    ...
    /** @see unarchive */
    fun unarchive(params: CustomCurrencyUnarchiveParams): CompletableFuture<CustomCurrency> =
    ...
    interface WithRawResponse {
        ...
        fun create(
            params: CustomCurrencyCreateParams
        ): CompletableFuture<HttpResponseFor<CustomCurrency>> =
            create(params, RequestOptions.none())
         ...
         */
        fun update(currencyId: String): CompletableFuture<HttpResponseFor<CustomCurrency>> =
            update(currencyId, CustomCurrencyUpdateParams.none())
         ...
         */
        fun archive(currencyId: String): CompletableFuture<HttpResponseFor<CustomCurrency>> =
            archive(currencyId, CustomCurrencyArchiveParams.none())
         ...
         */
        fun unarchive(currencyId: String): CompletableFuture<HttpResponseFor<CustomCurrency>> =
            unarchive(currencyId, CustomCurrencyUnarchiveParams.none())
