...
import io.stigg.services.blocking.v1.credits.AutoRechargeServiceImpl
...
import io.stigg.services.blocking.v1.credits.GrantServiceImpl
...
class CreditServiceImpl internal constructor(private val clientOptions: ClientOptions) :
    ...
    private val autoRecharge: AutoRechargeService by lazy { AutoRechargeServiceImpl(clientOptions) }
    ...
    override fun autoRecharge(): AutoRechargeService = autoRecharge
    ...
    class WithRawResponseImpl internal constructor(private val clientOptions: ClientOptions) :
        ...
        private val autoRecharge: AutoRechargeService.WithRawResponse by lazy {
            AutoRechargeServiceImpl.WithRawResponseImpl(clientOptions)
        }
        ...
        override fun autoRecharge(): AutoRechargeService.WithRawResponse = autoRecharge
