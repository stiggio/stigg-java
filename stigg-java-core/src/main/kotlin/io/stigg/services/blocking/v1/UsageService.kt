...
interface UsageService {
     ...
     */
    fun estimate(params: UsageEstimateParams): UsageEstimateResponse =
    ...
    interface WithRawResponse {
         ...
         * as [UsageService.estimate].
         */
        @MustBeClosed
        fun estimate(params: UsageEstimateParams): HttpResponseFor<UsageEstimateResponse> =
            estimate(params, RequestOptions.none())
