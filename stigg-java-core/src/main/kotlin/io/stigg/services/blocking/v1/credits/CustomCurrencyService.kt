...
interface CustomCurrencyService {
    ...
    fun create(params: CustomCurrencyCreateParams): CustomCurrency =
    ...
    fun update(currencyId: String): CustomCurrency =
    ...
    fun update(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CustomCurrency = update(params.toBuilder().currencyId(currencyId).build(), requestOptions)

    /** @see update */
    fun update(
        currencyId: String,
        params: CustomCurrencyUpdateParams = CustomCurrencyUpdateParams.none(),
    ): CustomCurrency = update(currencyId, params, RequestOptions.none())
    ...
    /** @see update */
    fun update(params: CustomCurrencyUpdateParams): CustomCurrency =
        update(params, RequestOptions.none())

    /** @see update */
    fun update(currencyId: String, requestOptions: RequestOptions): CustomCurrency =
     ...
     */
    fun archive(currencyId: String): CustomCurrency =
    ...
    fun archive(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CustomCurrency = archive(params.toBuilder().currencyId(currencyId).build(), requestOptions)

    /** @see archive */
    fun archive(
        currencyId: String,
        params: CustomCurrencyArchiveParams = CustomCurrencyArchiveParams.none(),
    ): CustomCurrency = archive(currencyId, params, RequestOptions.none())
    ...
    /** @see archive */
    fun archive(params: CustomCurrencyArchiveParams): CustomCurrency =
        archive(params, RequestOptions.none())

    /** @see archive */
    fun archive(currencyId: String, requestOptions: RequestOptions): CustomCurrency =
     ...
     */
    fun unarchive(currencyId: String): CustomCurrency =
    ...
    fun unarchive(
        ...
        requestOptions: RequestOptions = RequestOptions.none(),
    ): CustomCurrency = unarchive(params.toBuilder().currencyId(currencyId).build(), requestOptions)

    /** @see unarchive */
    fun unarchive(
        currencyId: String,
        params: CustomCurrencyUnarchiveParams = CustomCurrencyUnarchiveParams.none(),
    ): CustomCurrency = unarchive(currencyId, params, RequestOptions.none())
    ...
    /** @see unarchive */
    fun unarchive(params: CustomCurrencyUnarchiveParams): CustomCurrency =
        unarchive(params, RequestOptions.none())

    /** @see unarchive */
    fun unarchive(currencyId: String, requestOptions: RequestOptions): CustomCurrency =
    ...
    interface WithRawResponse {
         ...
         */
        @MustBeClosed
        fun create(params: CustomCurrencyCreateParams): HttpResponseFor<CustomCurrency> =
            create(params, RequestOptions.none())
        ...
        fun create(
            params: CustomCurrencyCreateParams,
            requestOptions: RequestOptions = RequestOptions.none(),
        ): HttpResponseFor<CustomCurrency>
         ...
         */
        @MustBeClosed
        fun update(currencyId: String): HttpResponseFor<CustomCurrency> =
            update(currencyId, CustomCurrencyUpdateParams.none())
        ...
        fun update(
            currencyId: String,
            params: CustomCurrencyUpdateParams = CustomCurrencyUpdateParams.none(),
        ): HttpResponseFor<CustomCurrency> = update(currencyId, params, RequestOptions.none())
        ...
        /** @see update */
        @MustBeClosed
        fun update(params: CustomCurrencyUpdateParams): HttpResponseFor<CustomCurrency> =
            update(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun archive(currencyId: String): HttpResponseFor<CustomCurrency> =
            archive(currencyId, CustomCurrencyArchiveParams.none())
        ...
        fun archive(
            currencyId: String,
            params: CustomCurrencyArchiveParams = CustomCurrencyArchiveParams.none(),
        ): HttpResponseFor<CustomCurrency> = archive(currencyId, params, RequestOptions.none())
        ...
        /** @see archive */
        @MustBeClosed
        fun archive(params: CustomCurrencyArchiveParams): HttpResponseFor<CustomCurrency> =
            archive(params, RequestOptions.none())
         ...
         */
        @MustBeClosed
        fun unarchive(currencyId: String): HttpResponseFor<CustomCurrency> =
            unarchive(currencyId, CustomCurrencyUnarchiveParams.none())
        ...
        fun unarchive(
            currencyId: String,
            params: CustomCurrencyUnarchiveParams = CustomCurrencyUnarchiveParams.none(),
        ): HttpResponseFor<CustomCurrency> = unarchive(currencyId, params, RequestOptions.none())
        ...
        /** @see unarchive */
        @MustBeClosed
        fun unarchive(params: CustomCurrencyUnarchiveParams): HttpResponseFor<CustomCurrency> =
            unarchive(params, RequestOptions.none())
