...
import io.stigg.client.okhttp.OkHttpClient
import io.stigg.core.RequestOptions
import io.stigg.core.Sleeper
import io.stigg.errors.StiggRetryableException
        ...
        val failingHttpClient =
            object : HttpClient {
                override fun execute(
                    ...
                    callCount++
                    if (callCount == 1) {
                        throw StiggRetryableException("Simulated retryable failure")
                    }
                ...
                override fun executeAsync(
                    ...
                    if (callCount == 1) {
                        ...
                        future.completeExceptionally(
                            StiggRetryableException("Simulated retryable failure")
                        )
                        return future
                    }
