...
internal class AddonListAddonsParamsTest {

    @Test
    fun create() {
        AddonListAddonsParams.builder()
            .after("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
            .before("182bd5e5-6e1a-4fe4-a799-aa6d9a6ab26e")
            .createdAt(
                AddonListAddonsParams.CreatedAt.builder()
    ...
    fun queryParamsWithoutOptionalFields() {
        val params = AddonListAddonsParams.builder().build()
