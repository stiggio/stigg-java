...
internal class CustomCurrencyServiceAsyncTest {
    ...
    fun create() {
        ...
        val customCurrencyServiceAsync = client.v1().events().credits().customCurrencies()
    ...
    fun archive() {
        ...
        val responseFuture = customCurrencyServiceAsync.archive("currencyId")
    ...
    fun unarchive() {
        ...
        val responseFuture = customCurrencyServiceAsync.unarchive("currencyId")
