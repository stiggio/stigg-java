...
dependencies {
    testImplementation(project(":stigg-java"))
...
val proguardJar by tasks.registering(proguard.gradle.ProGuardTask::class) {
    ...
    configuration("../stigg-java-core/src/main/resources/META-INF/proguard/stigg-java-core.pro")
}
...
val testProGuard by tasks.registering(JavaExec::class) {
    ...
    mainClass.set("com.stigg.api.proguard.ProGuardCompatibilityTest")
...
val r8Jar by tasks.registering(JavaExec::class) {
    ...
    args = listOf(
        ...
        "--pg-conf", "./test.pro",
        "--pg-conf", "../stigg-java-core/src/main/resources/META-INF/proguard/stigg-java-core.pro",
